  ...
  width: 25px;
    ...
    <body>
        ...
        <div class="menu cor3">
            ...
            <ul class= "nav">
                <li><a href='lista_aulas.php' style="color:#002a80"><h4>Episodio 4 - Aula 16 - Lição 1 - Parte 4</h4></a></li>
                <li style="margin-left:400px;"><h4><a href="Filme_ep_4_aula16_lic1_part3.php"><img  src="img/back.png" style="width:20px;" border="0"></a>Lição 1 - Parte 4 <a href="Filme_ep_4_aula16_lic2_part1.php"> <img  src="img/next-1.png" style="width:20px;" border="0"></a> </h4></li>
...
<video id="video" src="https://videos.universidadedoingles.com.br/agentes/videos/Ag_E4_P4.mp4" ></video>
  </div>
</div>
<script>
...
<script>
    ...
    <form method="POST" action="mail.php">
                         <INPUT TYPE="hidden" NAME="b1" step="any" value="49.51">


                                             <p> De acordo com a parte do filme acima, escolha a alternativa correta:</p>
                    <ul class="payment-methods">
 <li class="payment-method2 paypal">
                    <input type="radio" name="msg" value="David is happy to be arrested."/> <label for="paypal" style="font-size:18px;">David is happy to be arrested. David está feliz em estar preso.<br /></label>
                    </li>
                    <li class="payment-method2 paypal">
                    <input type="radio" name="msg" value="Thompson shows up and talks with David."/> <label for="paypal" style="font-size:18px;"> Thompson shows up and talks with David. Thompson aparece e conversa com David.<br /></label>
                    </li>
                    <li class="payment-method paypal">
                    <input type="radio" name="msg" value="They are talking about David's interview."/> <label for="paypal" style="font-size:18px;"> They are talking about David's interview. Eles estão falando sobre a entrevista de David. <br/> </label>
                     </li>
                 </ul>
