  ...
  width: 25px;
    ...
    <body>
        ...
        <div class="menu cor3">
            ...
            <ul class= "nav">
                <li><a href='lista_aulas.php' style="color:#002a80"><h4>Episodio 1 - Aula 2 - Lição 1 - Parte 2</h4></a></li>
                <li style="margin-left:400px;"><h4><a href="Filme_ep_1_aula2_lic1_part1.php"><img  src="img/back.png" style="width:20px;" border="0"></a>Lição 1 - Parte 2 <a href="Filme_ep_1_aula2_lic1_part3.php"> <img  src="img/next-1.png" style="width:20px;" border="0"></a> </h4></li>
...
<INPUT TYPE="hidden" NAME="b1" step="any" value="4.18">
                        <p> De acordo com a parte do filme acima, escolha a alternativa correta:</p>

                    <ul class="payment-methods">
                <li class="payment-method2 paypal">
                    <input type="radio" name="msg" value="David goes into the women 's restroom."/> <label for="paypal" style="font-size:18px;"> David goes into the women 's restroom. David entra no banheiro feminino.<br /> </label>
                    </li>
                    <li class="payment-method paypal">
                    <input type="radio" name="msg" value="The woman goes into the men's restroom."/> <label for="paypal" style="font-size:18px;"> The woman goes into the men's restroom. A mulher entra no banheiro masculino.<br /> </label>
                    </li>
                    <li class="payment-method2 paypal">
                    <input type="radio" name="msg" value=" The woman goes into the women 's restroom."/><label for="paypal" style="font-size:18px;">  The woman goes into the women 's restroom. A mulher entra no banheiro feminino. <br /> </label>
                </li>
