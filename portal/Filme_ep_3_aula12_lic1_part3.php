   ...
   /* GLOBAL STYLES
    ...
    <body>
        ...
        <div class="menu cor3">
            ...
            <ul class= "nav">
                <li><a href='lista_aulas.php' style="color:#002a80"><h4>Episodio 3 - Aula 12 - Lição 1 - Parte 3</h4></a></li>
                <li style="margin-left:400px;"><h4><a href="Filme_ep_3_aula12_lic1_part2.php"><img  src="img/back.png" style="width:20px;" border="0"></a>Lição 1 - Parte 3 <a href="Filme_ep_3_aula12_lic1_part4.php"> <img  src="img/next-1.png" style="width:20px;" border="0"></a> </h4></li>
...
<script>
    $(document).ready(function() {
                         ...
                         <INPUT TYPE="hidden" NAME="b1" step="any" value="36.96">

                                      <p> De acordo com a parte do filme acima, escolha a alternativa correta:</p>
                    <ul class="payment-methods">
 <li class="payment-method paypal">
                    <input type="radio" name="msg" value="David doesn´t concede interviews because he is tired."/><label for="paypal" style="font-size:18px;">David doesn´t concede interviews because he is tired. David não dá entrevistas porque está cansado.<br /> </label>
                    </li>
                    <li class="payment-method2 paypal">
                    <input type="radio" name="msg" value="David talks to the reporters about the Senate."/> <label for="paypal" style="font-size:18px;">David talks to the reporters about the Senate. David fala ao repórter sobre o Senado.<br /></label>
                    </li>
                    <li class="payment-method2 paypal">
                    <input type="radio" name="msg" value="David doesn´t concede interviews because he wants to see Elise."/><label for="paypal" style="font-size:18px;"> David doesn´t concede interviews because he wants to see Elise. David não dá entrevistas porque ele quer ver Elise. <br /></label>
                </li>
            </ul>
