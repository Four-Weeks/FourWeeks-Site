  ...
  width: 25px;
    ...
    <body>
        ...
        <div class="menu cor3">
            ...
            <ul class= "nav">
                <li><a href='lista_aulas.php' style="color:#002a80"><h4>Episodio 3 - Aula 12 - Lição 1 - Parte 2</h4></a></li>
                <li style="margin-left:400px;"><h4><a href="Filme_ep_3_aula12_lic1_part1.php"><img  src="img/back.png" style="width:20px;" border="0"></a>Lição 1 - Parte 2 <a href="Filme_ep_3_aula12_lic1_part3.php"> <img  src="img/next-1.png" style="width:20px;" border="0"></a> </h4></li>
...
<script>
    $(document).ready(function() {
          ...
          <form method="POST" action="mail.php">
                         <INPUT TYPE="hidden" NAME="b1" step="any" value="36.74">

                        <p> De acordo com a parte do filme acima, escolha a alternativa correta:</p>

                    <ul class="payment-methods">
 <li class="payment-method2 paypal">
                    <input type="radio" name="msg" value="The agents want Elise and David to kiss each other."/> <label for="paypal" style="font-size:18px;">The agents want Elise and David to kiss each other. Os Agentes querem que Elise e David se beijem.<br /></label>
                    </li>
                    <li class="payment-method paypal">
                    <input type="radio" name="msg" value="The agents don´t want Elise and David to kiss each other."/> <label for="paypal" style="font-size:18px;">The agents don´t want Elise and David to kiss each other. Os Agentes não querem que Elise e David se beijem.<br /></label>
                    </li>
                    <li class="payment-method2 paypal">
                    <input type="radio" name="msg" value="Elise and David were not found by the agents."/> <label for="paypal" style="font-size:18px;">Elise and David were not found by the agents. Elise e David não foram encontrados pelos agentes.<br /></label>
                </li>
                </ul>
