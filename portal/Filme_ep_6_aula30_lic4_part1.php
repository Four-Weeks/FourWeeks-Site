 ...
 ul { list-style: none; }
    ...
    <body>
        ...
        <div class="menu cor3">
            ...
            <ul class= "nav">
                <li><a href='lista_aulas.php' style="color:#002a80"><h4>Episodio 5 - Aula 25 - Lição 4 - Parte 1</h4></a></li>
                <li style="margin-left:400px;"><h4><a href="Filme_ep_5_aula25_lic3_part4.php"><img  src="img/back.png" style="width:20px;" border="0"></a>Lição 4 - Parte 1 <a href="Filme_ep_5_aula25_lic4_part2.php"> <img  src="img/next-1.png" style="width:20px;" border="0"></a> </h4></li>
...
<h2>Gravações</h2>
  ...
  <p style="margin-left:500px;">Did your parents read to you when you were a child?</p>
  ...
  <p>What was the last book you read about?</p>
  <button onclick="startRecording(this);insereTexto()" style="margin-left:100px; border-width:0px;border-radius:100px;background-color:rgba(44, 44, 49, 0.4);"><img src="img/gravador.png" style="width:38px;"></button>
  <button onclick="stopRecording(this); TrocaTexto()" style=" border-width:0px;border-radius:100px; background-color:rgba(44, 44, 49, 0.4);" disabled><img src="img/stop.png" style="width:40px;"></button>
 
   <p style="margin-left:500px;">Can a book change the world?</p>
  <button onclick="startRecording(this); insereTexto()" style="margin-left:600px; border-width:0px;border-radius:100px;background-color:rgba(44, 44, 49, 0.4);"><img src="img/gravador.png" style="width:38px;"></button>
  <button onclick="stopRecording(this); TrocaTexto()" style=" border-width:0px;border-radius:100px; background-color:rgba(44, 44, 49, 0.4);" disabled><img src="img/stop.png" style="width:40px;"></button>
 ...
 <p style="margin-left:500px;">Do you think people don’t read enough books these days?</p>
  <button onclick="startRecording(this);insereTexto()" style="margin-left:600px; border-width:0px;border-radius:100px;background-color:rgba(44, 44, 49, 0.4);"><img src="img/gravador.png" style="width:38px;"></button>
  <button onclick="stopRecording(this); TrocaTexto()" style=" border-width:0px;border-radius:100px; background-color:rgba(44, 44, 49, 0.4);" disabled><img src="img/stop.png" style="width:40px;"></button>
