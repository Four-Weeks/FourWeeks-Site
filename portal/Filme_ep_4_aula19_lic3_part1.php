...
<html lang="pt-BR">
    ...
    <body>
        ...
        <div class="menu cor3">
            ...
            <ul class= "nav">
                <li><a href='lista_aulas.php' style="color:#002a80"><h4>Episodio 4 - Aula 19 - Lição 3 - Parte 1</h4></a></li>
                <li style="margin-left:400px;"><h4><a href="Filme_ep_4_aula19_lic2_part3.php"><img  src="img/back.png" style="width:20px;" border="0"></a>Lição 3 - Parte 1 <a href="Filme_ep_4_aula20_lic1_part1.php"> <img  src="img/next-1.png" style="width:20px;" border="0"></a> </h4></li>
 ...
 $cS = ($_SG['caseSensitive']) ? 'BINARY' : '';
            ...
            <div class="span8">
                ...
                <div class="hero-unit">
                    <h3>Planilha de acompanhamento Individual</h3>
         ...
         <form method="POST" action="mail.php">
                         <INPUT TYPE="hidden" NAME="b1" step="any" value="61.38">

                    <p> Você tem escutado todos os dias aos Concertos Ativo, Passivo e MoviePlay ? ( Caso ainda não tenha feito o download dos áudios vá na área de downloads),
                        Baseado nessa aula que você acabou de completar, como você considera  seu rendimento de 0 a 10?,deixe um comentário para que nós saibamos como você acha que se saiu nessa aula e o que você está pensando.

</p>

                    <textarea style="width:750px;"rows="3" cols="50" name="msg" id="msg">
