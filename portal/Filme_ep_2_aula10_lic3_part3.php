...
<html lang="pt-BR">
    ...
    <body>
        ...
        <div class="menu cor3">
            ...
            <ul class= "nav">
                <li><a href='lista_aulas.php' style="color:#002a80"><h4>Episodio 2 - Aula 10 - Lição 3 - Parte 3</h4></a></li>
                <li style="margin-left:400px;"><h4><a href="Filme_ep_2_aula10_lic3_part2.php"><img  src="img/back.png" style="width:20px;" border="0"></a>Lição 3 - Parte 3 <a href="Filme_ep_2_aula10_lic3_part4.php"> <img  src="img/next-1.png" style="width:20px;" border="0"></a> </h4></li>
        ...
        <!-- SUBMIT -->
                    ...
                    <div class="content list" style="background:white;"> 
                                            ...
                                            <br>
                                             ...
                                             <p> Com a matéria "Why/Because" explicada crie 5 frases usando os porques, como por exemplo:</p>
                                            <br>
                                            <p>Why do you eat?</p>
                         ...
                         <INPUT TYPE="hidden" NAME="b1" step="any" value="31.9">
