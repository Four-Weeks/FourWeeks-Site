  ...
  width: 25px;
    ...
    <body>
        ...
        <div class="menu cor3">
            ...
            <ul class= "nav">
                <li><a href='lista_aulas.php' style="color:#002a80"><h4>Episodio 3 - Aula 11 - Lição 1 - Parte 3</h4></a></li>
                <li style="margin-left:400px;"><h4><a href="Filme_ep_3_aula11_lic1_part2.php"><img  src="img/back.png" style="width:20px;" border="0"></a>Lição 1 - Parte 3 <a href="Filme_ep_3_aula11_lic1_part4.php"> <img  src="img/next-1.png" style="width:20px;" border="0"></a> </h4></li>
...
<video id="video" src="https://videos.universidadedoingles.com.br/agentes/videos/Ag_E3_P3.mp4" ></video>
  </div>
</div>
<script>
...
<script>
    $(document).ready(function() {
                  ...
                  <form method="POST" action="mail.php">
                         <INPUT TYPE="hidden" NAME="b1" step="any" value="33.22">
                    <p> De acordo com a parte do filme acima, escolha a alternativa correta:</p>
                    <ul class="payment-methods">
 <li class="payment-method2 paypal">
                    <input type="radio" name="msg" value="The agents are trying to make David and Elise be together."/> <label for="paypal" style="font-size:18px;">The agents are trying to make David and Elise be together. Os agentes estão tentando fazer com que David e Elise fiquem juntos.<br /> </label>
                    </li>
                    <li class="payment-method2 paypal">
                    <input type="radio" name="msg" value="The agents are trying to make David do the speech."/> <label for="paypal" style="font-size:18px;">The agents are trying to make David do the speech. Os agentes estão tentando fazer com que David faça o discurso.<br /></label>
                    </li>
                    <li class="payment-method paypal">
                    <input type="radio" name="msg" value="The agents are trying to separate David and Elise."/><label for="paypal" style="font-size:18px;">The agents are trying to separate David and Elise. Os agentes estão tentando separar David e Elise.<br /></label>
                </li>
