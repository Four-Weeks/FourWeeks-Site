  ...
  width: 25px;
    ...
    <body>
        ...
        <div class="menu cor3">
            ...
            <ul class= "nav">
                <li><a href='lista_aulas.php' style="color:#002a80"><h4>Episodio 2 - Aula 7 - Lição 1 - Parte 1</h4></a></li>
                <li style="margin-left:400px;"><h4>Lição 1 - Parte 1 <a href="Filme_ep_2_aula7_lic1_part2.php"> <img  src="img/next-1.png" style="width:20px;" border="0"></a> </h4></li>
...
<script>
    $(document).ready(function() {
         ...
         <form method="POST" action="mail.php">
                         <INPUT TYPE="hidden" NAME="b1" step="any" value="20.24">

                    <p> De acordo com a parte do filme acima, escolha a alternativa correta:</p>

<ul class="payment-methods">
 <li class="payment-method2 paypal">
                    <input type="radio" name="msg" id="msg" value="David meets his mother at the bus."/> <label for="paypal" style="font-size:18px;"> David meets his mother at the bus. David encontra a mãe dele no onibus.<br /></label>
                    </li>
                     <li class="payment-method paypal">
                    <input type="radio"   name="msg" id="msg" value="David meets the girl from the restroom again."/> <label for="paypal" style="font-size:18px;">David meets the girl from the restroom again. David encontra a moça do banheiro de novo.<br/> </label>
                    </li>
                     <li class="payment-method2 paypal">
                    <input type="radio"   name="msg" id="msg" value="David´s cellphone it´s not ringing"/> <label for="paypal" style="font-size:18px;"> David´s cellphone it´s not ringing. O Celular do David não está tocando. <br/> </label>
                </li>
            </ul>
