    ...
    <body>
        ...
        <div class="menu cor3">
            ...
            <ul class= "nav">
                ...
                <li style="margin-left:400px;"><h4><a href="Filme_ep_5_aula25_lic4_part1.php"><img  src="img/back.png" style="width:20px;" border="0"></a>Lição 4 - Parte 2 <a href="Filme_ep_6_aula26_lic1_part1.php"> <img  src="img/next-1.png" style="width:20px;" border="0"></a> </h4></li>
