...
<html lang="pt-BR">
    ...
    <body>
        ...
        <div class="menu cor3">
            ...
            <ul class= "nav">
                <li><a href='lista_aulas.php' style="color:#002a80"><h4>Episodio 5 - Aula 25 - Lição 3 - Parte 1</h4></a></li>
                <li style="margin-left:400px;"><h4><a href="Filme_ep_5_aula25_lic2_part4.php"><img  src="img/back.png" style="width:20px;" border="0"></a>Lição 3 - Parte 1 <a href="Filme_ep_5_aula25_lic3_part2.php"> <img  src="img/next-1.png" style="width:20px;" border="0"></a> </h4></li>
 ...
 $cS = ($_SG['caseSensitive']) ? 'BINARY' : '';
    ...
    <div class="audio">
      <audio id="player_instrucao">
        <source src="audios/Dialogo.m4a" type="audio/mpeg">
  ...
  function addZero(number){if(number < 10){return "0"+number;}else{return number;}}
        ...
        <!-- SUBMIT -->
                    ...
                    <div class="content list" style="background:white;"> 
                        <iframe width="560" height="315" src="https://www.youtube.com/embed/b4Bj7Zb-YD4?rel=0" frameborder="0" allowfullscreen></iframe>
...
<p>Why wait to say? At least I did it my way</p>
Lie awake, two faced </p>
But in my heart I understand</p>
I made my move and it was all about you</p>
Now I feel so far removed</p>

You were the one thing in my way</p>
You were the one thing in my way</p>
You were the one thing in my way</p>
...
Why wait to say? At least I did it my way</p>
Lie awake, two faced</p>
But in my heart I understand</p>
I made my move and it was all about you</p>
Now I feel so far removed</p>
...
<p>Para que esperar para dizer? Pelo menos eu fiz do meu jeito</p>
Deitado acordado, duas caras</p>
Mas no meu coração, eu entendo</p>
Eu fiz minha jogada e foi tudo por você</p>
Agora me sinto dispensado</p>

Você era a única coisa em meu caminho</p>
Você era a única coisa em meu caminho</p>
Você era a única coisa em meu caminho</p>
...
Meu caminho, oh caminho, oh caminho, oh caminho</p>
Meu caminho, oh caminho, oh caminho, oh caminho</p>
Meu caminho, oh caminho, oh caminho, oh caminho</p>
Meu caminho, oh caminho, oh caminho, oh caminho</p>
...
Para que esperar para dizer? Pelo menos eu fiz do meu jeito</p>
Deitado acordado, duas caras</p>
Mas em meu coração, eu entendo</p>
Eu fiz minha jogada e foi tudo por você</p>
Agora me sinto dispensado</p>
...
Meu caminho, oh caminho, oh caminho, oh caminho</p>
                    ...
                    <form method="POST" action="mail.php">
                         <INPUT TYPE="hidden" NAME="b1" step="any" value="78.76">
                        <INPUT TYPE="hidden" NAME="msg" value="Parabéns por mais essa etapa (Aula 25 Lição 3 Parte 1)">
