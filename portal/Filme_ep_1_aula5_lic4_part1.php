 ...
 ul { list-style: none; }
    ...
    <body>
        ...
        <div class="menu cor3">
            ...
            <ul class= "nav">
                <li><a href='lista_aulas.php' style="color:#002a80"><h4>Episodio 1 - Aula 5 - Lição 4 - Parte 1</h4></a></li>
                <li style="margin-left:400px;"><h4><a href="Filme_ep_1_aula5_lic3_part4.php"><img  src="img/back.png" style="width:20px;" border="0"></a>Lição 4 - Parte 1 <a href="Filme_ep_1_aula5_lic4_part2.php"> <img  src="img/next-1.png" style="width:20px;" border="0"></a> </h4></li>
...
<h2>Gravações</h2>
  ...
  <p>Could you tell us your full name?</p>
  ...
  <p style="margin-left:500px;">How old are you?</p>
  ...
  <button onclick="stopRecording(this); TrocaTexto()" style=" border-width:0px;border-radius:100px; background-color:rgba(44, 44, 49, 0.4);" disabled><img src="img/stop.png" style="width:40px;"></button>
   ...
   <p style="margin-left:500px;">What do you intend to do about your life?</p>
  <button onclick="startRecording(this); insereTexto()" style="margin-left:600px; border-width:0px;border-radius:100px;background-color:rgba(44, 44, 49, 0.4);"><img src="img/gravador.png" style="width:38px;"></button>
  <button onclick="stopRecording(this); TrocaTexto()" style=" border-width:0px;border-radius:100px; background-color:rgba(44, 44, 49, 0.4);" disabled><img src="img/stop.png" style="width:40px;"></button>
 
  <p>Why English is so important?</p>
  <button onclick="startRecording(this);insereTexto()" style="margin-left:100px; border-width:0px;border-radius:100px;background-color:rgba(44, 44, 49, 0.4);"><img src="img/gravador.png" style="width:38px;"></button>
  <button onclick="stopRecording(this); TrocaTexto()" style=" border-width:0px;border-radius:100px; background-color:rgba(44, 44, 49, 0.4);" disabled><img src="img/stop.png" style="width:40px;"></button>
 

 <p style="margin-left:500px;">What job do you want work?</p>
  <button onclick="startRecording(this);insereTexto()" style="margin-left:600px; border-width:0px;border-radius:100px;background-color:rgba(44, 44, 49, 0.4);"><img src="img/gravador.png" style="width:38px;"></button>
  <button onclick="stopRecording(this); TrocaTexto()" style=" border-width:0px;border-radius:100px; background-color:rgba(44, 44, 49, 0.4);" disabled><img src="img/stop.png" style="width:40px;"></button>
...
<form method="POST" action="mail.php">
                         <INPUT TYPE="hidden" NAME="b1" step="any" value="16.06">
