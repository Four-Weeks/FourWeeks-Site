  ...
  width: 25px;
    ...
    <body>
        ...
        <div class="menu cor3">
            ...
            <ul class= "nav">
                <li><a href='lista_aulas.php' style="color:#002a80"><h4>Episodio 2 - Aula 7 - Lição 1 - Parte 2</h4></a></li>
                <li style="margin-left:400px;"><h4><a href="Filme_ep_2_aula7_lic1_part1.php"><img  src="img/back.png" style="width:20px;" border="0"></a>Lição 1 - Parte 2 <a href="Filme_ep_2_aula7_lic1_part3.php"> <img  src="img/next-1.png" style="width:20px;" border="0"></a> </h4></li>
...
<script>
    $(document).ready(function() {
         ...
         <form method="POST" action="mail.php">
                         <INPUT TYPE="hidden" NAME="b1" step="any" value="20.25">
                    <p> De acordo com a parte do filme acima, escolha a alternativa correta:</p>

                    <ul class="payment-methods">
 <li class="payment-method2 paypal">
                    <input type="radio" name="msg" value="The secretary helps David to run away from the agents."/> <label for="paypal" style="font-size:18px;">The secretary helps David to run away from the agents. A secretária ajuda o David a fugir dos agentes. <br /></label>
                    </li>
                    <li class="payment-method paypal">
                    <input type="radio" name="msg" value="There are a lot of agents."/> <label for="paypal" style="font-size:18px;">There are a lot of agents. Há vários agentes.<br /></label>
                    </li>
                    <li class="payment-method2 paypal">
                    <input type="radio" name="msg" value="David doesn´t go to his job."/> <label for="paypal" style="font-size:18px;">David doesn´t go to his job. David não vai ao trabalho. <br /></label>
                </li>
                </ul>
