...
<html lang="pt-BR">
    ...
    <body>
        ...
        <div class="menu cor3">
            ...
            <ul class= "nav">
                <li><a href='lista_aulas.php' style="color:#002a80"><h4>Episodio 1 - Aula 3 - Lição 3 - Parte 1</h4></a></li>
                <li style="margin-left:400px;"><h4><a href="Filme_ep_1_aula3_lic2_part4.php"><img  src="img/back.png" style="width:20px;" border="0"></a>Lição 3 - Parte 1 <a href="Filme_ep_1_aula3_lic3_part2.php"> <img  src="img/next-1.png" style="width:20px;" border="0"></a> </h4></li>
        ...
        <!-- SUBMIT -->
                    ...
                    <div class="content list" style="background:white;"> 
                        ...
                        <div class ="list">
                         ...
                         <INPUT TYPE="hidden" NAME="b1" step="any" value="9.46">
                       Traduza o texto aqui:
                            <textarea rows="3" style="width:350px; height:4300px;" cols="50" name="msg" id="msg">
