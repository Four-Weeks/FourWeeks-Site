...
<html lang="pt-BR">
    ...
    <body>
        ...
        <div class="menu cor3">
            ...
            <ul class= "nav">
                <li><a href='lista_aulas.php' style="color:#002a80"><h4>Episodio 2 - Aula 7 - Lição 2 - Parte 2</h4></a></li>
                <li style="margin-left:400px;"><h4><a href="Filme_ep_2_aula7_lic2_part1.php"><img  src="img/back.png" style="width:20px;" border="0"></a>Lição 2 - Parte 2 <a href="Filme_ep_2_aula7_lic2_part3.php"> <img  src="img/next-1.png" style="width:20px;" border="0"></a> </h4></li>
                            ...
                            <div class="tabbable"> <!-- Only required for left/right tabs -->
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active" id="tab1">
                                       ...
                                       <p>Charlie: I just don't think the research is there</p>
Charlie: and the price point is too high on</p>
these things.</p>
David: Of course, it's too high.</p>
David: But if our company doesn't get involved</p>
with stuff like this, who will?</p>
Charlie: Convince me in the meeting.</p>
David: I will. See you, buddy.</p>
David: Hey, Janet.</p>
David: Hey, Susan.</p>
Richardson: We just got approval for a</p>
recalibration on the Lasalle case.</p>
Richardson: Two minutes.</p>
David: Hey!</p>
David: What the hell are you doing?</p>
Richardson: Grab him.</p>
David: 9-1-1, Janet! 9-1-1! Oh.</p>
Richardson: You can't get away, David.</p>
Richardson: David, I really wish</p>
you'd just listen to me.</p>
Richardson: All right, I'll handle it.</p>
Richardson: David,</p>
Richardson: you really are making this</p>
harder than it has to be.</p>
Harry: All right, take it easy, guys.</p>
Take it easy.</p>
Harry: Take it easy.</p>
Harry: It's okay, David.</p>
Richardson: No. No, sir.</p>
Richardson: It's being taken care of.</p>
Richardson: Yes, sir. No, sir.</p>
Richardson: No, sir. Yes, sir.</p>
Richardson: I understand. I'll take care of it.</p>
Richardson: What a goddamn mess.</p>
Agent: Donaldson?</p>
Richardson: Yes.</p>
Man: What do you want to do?</p>
Richardson: We have to reset him.</p>
Call for a briefcase.</p>
Man: You kidding? It's going to take a signed</p>
order from the Chairman.</p>
Richardson: Get legal on it.</p>
Man: Legal just arrived.</p>
Man: There's no way the Chairman</p>
approves a reset.</p>
Man: This is your fault. There is no way</p>
you get a briefcase.</p>
David: Hey.</p>
Richardson: What are my options?</p>
David: Hey.</p>
Man: Just bullshit him.</p>
Richardson: Bullshit this guy?</p>
David: Hey! What's going on here?</p>
Richardson: Look at this.</p>
Richardson: Questions will burn in him</p>
till the day he dies.</p>
Richardson: He won't stop searching for</p>
answers.</p>
He won't quit.</p>
Richardson: We have to watch him</p>
Richardson: forever, make sure</p>
he doesn't talk.</p>
Richardson: Endless ripple effects.</p>
Man: You remember the Torres case</p>
40 years ago?</p>
Richardson: It's not that bad, is it?</p>
Man: In the end,</p>
they just leveled with him.</p>
Richardson: Completely?</p>
Man: Looking at that, I don't see you</p>
have a choice.</p>
David: Who the hell are you guys?</p>
Richardson: We</p>
Richardson: are the people who make sure</p>
things happen according to plan.</p>
Richardson: My name is Richardson.</p>
David: Oh.</p>
                                    ...
                                    <div class="tab-pane" id="tab2">
                                        <p> Charlie: Eu não acho que a pesquisa está nisso
Charlie: e o preço dessas coisas é</p>
muito elevado.</p>
David: Claro que é muito alto,</p>
David: mas se a nossa empresa não se</p>
envolver com coisas assim, quem irá?</p>
Charlie: Me convença nessa reunião.</p>
David: Pode deixar. Até logo.</p>
David: Oi, Janet.</p>
David: Oi, Susan.</p>
Richardson: Nós acabamos de obter aprovação</p>
para uma recalibração no caso Lassalle.</p>
Richardson: Dois minutos.</p>
David: Ei!</p>
David: Que diabos estão fazendo?</p>
Richardson: Agarrem-no.</p>
David: Chame a polícia, Janet! A polícia!</p>
Richardson: Não pode fugir, David.</p>
Richardson: David, gostaria muito</p>
que você apenas me ouvisse.</p>
Richardson: Muito bem, eu cuidarei disso.</p>
Richardson: David,</p>
Richardson: está tornando tudo</p>
mais complicado do que tem de ser.</p>
Harry: Muito bem, com calma rapazes.</p>
Calma.</p>
Harry: Tenha calma.</p>
Harry: Está tudo bem, David.</p>
Richardson: Não. Não, senhor.</p>
Richardson: Está sendo cuidado.</p>
Richardson: Sim, senhor. Não, senhor.</p>
Richardson: Não senhor. Sim senhor.</p>
Richardson: Entendo. Eu cuidarei disso.</p>
Richardson: Que bagunça desgraçada.</p>
Agente: Donaldson?</p>
Richardson: Sim.</p>
Homem: O que quer fazer?</p>
Richardson: Temos de reiniciá-lo.</p>
Peça a valise.</p>
Homem: Está brincando? Precisa de</p>
Ordem assinada do Presidente.</p>
Richardson: Chame o jurídico.</p>
Homem: O jurídico acabou de chegar</p>
Homem: Não tem nenhuma chance do</p>
presidente aprovar a reinicialização.</p>
Homem: A culpa é sua. Não tem nenhuma</p>
chance de você pegar uma valise.</p>
David: Ei!</p>
Richardson: Quais são as minhas opções?</p>
David: Ei!</p>
Homem: Apenas o engane</p>
Richardson: Enganar essa cara?</p>
David: Ei! O que está havendo?</p>
Richardson: Veja só.</p>
Richardson: Perguntas vão queimá-lo até o dia</p>
em que ele morrer.</p>
Richardson: Não deixará de procurar por</p>
respostas.</p>
Não desistirá.</p>
Richardson: Teremos que vigiá-lo,</p>
Richardson: para sempre, para termos certeza</p>
que não falará.</p>
Richardson: Efeito cascata sem fim.</p>
Homem: Lembra-se do caso Torres</p>
há 40 anos?</p>
Richardson: Não é assim tão grave. É?</p>
Homem: No final,</p>
foram francos com ele.</p>
Richardson: Completamente?</p>
Homem: Olhando para isso não parece</p>
que você tem uma escolha.</p>
David: Quem diabos são vocês?</p>
Richardson: Nós…</p>
Richardson: somos aqueles que garantem que</p>
as coisas aconteçam de acordo com o plano.</p>
Richardson: O meu nome é Richardson.</p>
David: Oh.</p>
                        ...
                        <source src="https://videos.universidadedoingles.com.br/yesman/audios/mp3/Ag_Mp_E2_P2.mp3" type="audio/mpeg">
                    </audio>
                            </div>
                        </div>
                    </div>
         ...
         <form method="POST" action="mail.php">
                         <INPUT TYPE="hidden" NAME="b1" step="any" value="21.34">
