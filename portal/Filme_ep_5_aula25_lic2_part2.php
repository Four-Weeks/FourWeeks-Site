...
<html lang="pt-BR">
    ...
    <body>
        ...
        <div class="menu cor3">
            ...
            <ul class= "nav">
                <li><a href='lista_aulas.php' style="color:#002a80"><h4>Episodio 5 - Aula 25 - Lição 2 - Parte 2</h4></a></li>
                <li style="margin-left:400px;"><h4><a href="Filme_ep_5_aula25_lic2_part1.php"><img  src="img/back.png" style="width:20px;" border="0"></a>Lição 2 - Parte 2 <a href="Filme_ep_5_aula25_lic2_part3.php"> <img  src="img/next-1.png" style="width:20px;" border="0"></a> </h4></li>
...
<script>
   ...
   <form method="POST" action="mail.php">
                         <INPUT TYPE="hidden" NAME="b1" step="any" value="78.10">
                    <INPUT TYPE="hidden" NAME="msg" value="Parabéns por mais essa etapa (Aula 25 Lição 2 Parte 2)">
