...
<html lang="pt-BR">
    ...
    <body>
        ...
        <div class="menu cor3">
            ...
            <ul class= "nav">
                <li><a href='lista_aulas.php' style="color:#002a80"><h4>Episodio 2 - Aula 7 - Lição 2 - Parte 4</h4></a></li>
                <li style="margin-left:400px;"><h4><a href="Filme_ep_2_aula7_lic2_part3.php"><img  src="img/back.png" style="width:20px;" border="0"></a>Lição 2 - Parte 4 <a href="Filme_ep_2_aula7_lic3_part1.php"> <img  src="img/next-1.png" style="width:20px;" border="0"></a> </h4></li>
...
te assustar.</p>
         ...
         <form method="POST" action="mail.php">
                         <INPUT TYPE="hidden" NAME="b1" step="any" value="21.57">
                         Digite 30 palavras que estão no texto com sua tradução:
                            <textarea rows="3" style="width:750px;" cols="50" name="msg" id="msg">

                                            
                                                    </textarea>
<div align="center"><button class="btn btn-primary" type="submit" name="1">ENVIAR MINHA LIÇÃO</div> 
</form>
