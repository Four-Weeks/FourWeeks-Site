    ...
    <body>
        ...
        <div class="row-fluid">
            ...
            <div class="span8">
                ...
                <div class="hero-unit">
                    <div align="center" style="overflow: auto;"> <h3>Gramática</h3></div>
                    <div> <button class=" bt_menu btn btn-primary"  onclick="window.location.href = 'menu.php';">Voltar</button></div>
                    <div align="center">
                   <button class="btn btn-primary"  onclick="window.location.href = 'gramatica1.php';">Gramática 1</button>
                   <button class="btn btn-primary"  onclick="window.location.href = 'gramatica2.php';">Gramática 2</button>
                   <button class="btn btn-primary"  onclick="window.location.href = 'gramatica3.php';">Gramática 3</button>
                   </div>
                    </div>
            </div>
        </div>
