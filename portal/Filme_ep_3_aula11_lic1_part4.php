...
.payment-method input:focus + label {
  outline: 2px dotted #33cc00;
}
.payment-method input:checked + label {
  outline: 4px solid #33cc00;
}
.payment-method2 input:focus + label {
  outline: 2px dotted #ec0000;
}
.payment-method2 input:checked + label {
  outline: 4px solid #ec0000;
}
.payment-method input:checked + label:after {
  background: url(img/correta.png);
  bottom: -10px;
  content: "";
...
.payment-method2 input:checked + label:after {
  background: url(img/errada.png);
  bottom: -10px;
  content: "";
  display: inline-block;
  height: 25px;
  ...
  width: 25px;
    ...
    <body>
        ...
        <div class="menu cor3">
            ...
            <ul class= "nav">
                <li><a href='lista_aulas.php' style="color:#002a80"><h4>Episodio 3 - Aula 11 - Lição 1 - Parte 4</h4></a></li>
                <li style="margin-left:400px;"><h4><a href="Filme_ep_3_aula11_lic1_part3.php"><img  src="img/back.png" style="width:20px;" border="0"></a>Lição 1 - Parte 4 <a href="Filme_ep_3_aula11_lic2_part1.php"> <img  src="img/next-1.png" style="width:20px;" border="0"></a> </h4></li>
...
<video id="video" src="https://videos.universidadedoingles.com.br/agentes/videos/Ag_E3_P4.mp4" ></video>
  </div>
</div>
<script>
...
<script>
    ...
    <form method="POST" action="mail.php">
                         <INPUT TYPE="hidden" NAME="b1" step="any" value="33.44">
                    <p> De acordo com a parte do filme acima, escolha a alternativa correta:</p>
                    <ul class="payment-methods">
 <li class="payment-method2 paypal">
                    <input type="radio" name="msg" value="David discovers the adress of the Cedar Lake Ballet Company through the internet. "/> <label for="paypal" style="font-size:18px;">David discovers the adress of the Cedar Lake Ballet Company through the internet. David descobre o endereço da Companhia de Ballet Cedar Lake pela internet.<br /></label>
                    </li>
                    <li class="payment-method2 paypal">
                    <input type="radio" name="msg" value="David discovers the adress of the Cedar Lake Ballet Company with his friend."/> <label for="paypal" style="font-size:18px;"> David discovers the adress of the Cedar Lake Ballet Company with his friend. David descobre o endereço da Companhia de Ballet Cedar Lake com seu amigo.<br /></label>
                    </li>
                    <li class="payment-method paypal">
                    <input type="radio" name="msg" value="David discovers the adress of the Cedar Lake Ballet Company asking inside a restaurant."/> <label for="paypal" style="font-size:18px;"> David discovers the adress of the Cedar Lake Ballet Company asking inside a restaurant. David descobre o endereço da Companhia de Ballet perguntado dentro de um restaurante. <br/> </label>
                     </li>
                 </ul>
