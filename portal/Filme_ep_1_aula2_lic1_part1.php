  ...
  width: 25px;
    ...
    <body>
        ...
        <div class="menu cor3">
            ...
            <ul class= "nav">
                <li><a href='lista_aulas.php' style="color:#002a80"><h4>Episodio 1 - Aula 2 - Lição 1 - Parte 1</h4></a></li>
                <li style="margin-left:400px;"><h4>Lição 1 - Parte 1 <a href="Filme_ep_1_aula2_lic1_part2.php"> <img  src="img/next-1.png" style="width:20px;" border="0"></a> </h4></li>
...
<video id="video" src="https://videos.universidadedoingles.com.br/agentes/videos/Ag_E1_P1.mp4" ></video>
  </div>
</div>
<script>
...
<INPUT TYPE="hidden" NAME="b1" step="any" value="3.96">
                                       <p> De acordo com a parte do filme acima, escolha a alternativa correta:</p>


                    <ul class="payment-methods">
                <li class="payment-method2 paypal">
                    <input type="radio" name="msg" id="msg" value="David Norris is running to be a senator in Florida"/> <label for="paypal" style="font-size:18px;"> David Norris is running to be a senator in Florida. David norris está concorrendo para ser um senador na Flórida.<br /></label>
                    </li> 
                  <li class="payment-method paypal"> 
                    <input type="radio"   name="msg" id="msg" value="David Norris is running to be a senator in New York."/> <label for="paypal" style="font-size:18px;">David Norris is running to be a senator in New York. David norris está concorrendo para ser um senador em Nova Iorque.<br /></label>
                    
                    </li> 
                  <li class="payment-method2 paypal"> 
                    <input type="radio"   name="msg" id="msg" value="David Norris is running to be the president of the USA."/> <label for="paypal" style="font-size:18px;"> David Norris is running to be the president of the USA. David norris está concorrendo para ser o Presidente dos EUA. <br /></label>
                  </li>
</ul>
