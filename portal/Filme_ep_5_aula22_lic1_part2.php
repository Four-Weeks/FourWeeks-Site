  ...
  width: 25px;
    ...
    <body>
        ...
        <div class="menu cor3">
            ...
            <ul class= "nav">
                <li><a href='lista_aulas.php' style="color:#002a80"><h4>Episodio 5 - Aula 22 - Lição 1 - Parte 2</h4></a></li>
                <li style="margin-left:400px;"><h4><a href="Filme_ep_5_aula22_lic1_part1.php"><img  src="img/back.png" style="width:20px;" border="0"></a>Lição 1 - Parte 2 <a href="Filme_ep_5_aula22_lic1_part3.php"> <img  src="img/next-1.png" style="width:20px;" border="0"></a> </h4></li>
...
<script>
    ...
    <form method="POST" action="mail.php">
                         <INPUT TYPE="hidden" NAME="b1" step="any" value="68.42">


                    <p> De acordo com a parte do filme acima, escolha a alternativa correta:</p>
                     <ul class="payment-methods">
 <li class="payment-method2 paypal">
                    <input type="radio" name="msg" value="David's friend tells him that Elise will get married."/><label for="paypal" style="font-size:18px;"> David's friend tells him that Elise will get married. O amigo de David diz a ele que Elise vai se casar.<br /> </label>
                    </li>
                    <li class="payment-method paypal">
                    <input type="radio" name="msg" value="David's friend tells him that Elise will stop dancing."/><label for="paypal" style="font-size:18px;">David's friend tells him that Elise will stop dancing. O amigo de David diz a ele que Elise vai parar de dançar.  <br /></label>
                   </li>
                   <li class="payment-method2 paypal">
                    <input type="radio" name="msg" value="David's friend tells him that Elise wants to see him again."/><label for="paypal" style="font-size:18px;"> David's friend tells him that Elise wants to see him again. O amigo de David diz a ele que Elise quer vê-lo de novo.<br /></label>
</li>
</ul>
