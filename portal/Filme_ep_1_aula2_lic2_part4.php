...
<html lang="pt-BR">
    ...
    <body>
        ...
        <div class="menu cor3">
            ...
            <ul class= "nav">
                <li><a href='lista_aulas.php' style="color:#002a80"><h4>Episodio 1 - Aula 2 - Lição 2 - Parte 4</h4></a></li>
                <li style="margin-left:400px;"><h4><a href="Filme_ep_1_aula2_lic2_part3.php"><img  src="img/back.png" style="width:20px;" border="0"></a>Lição 2 - Parte 4 <a href="Filme_ep_1_aula2_lic3_part1.php"> <img  src="img/next-1.png" style="width:20px;" border="0"></a> </h4></li>
...
<form method="POST" action="mail.php">
            <INPUT TYPE="hidden" NAME="b1" step="any" value="5.5">

                        Digite 30 palavras que estão no texto com sua tradução:
                            <textarea rows="3" style="width:350px;" cols="50" name="msg" id="msg">
...
<div align="center"><button class="btn btn-primary" type="submit" name="1">ENVIAR MINHA LIÇÃO</button></div> 
                                    ...
                                    <div class="tab-pane" id="tab2">
                                        <p>David: Vá buscar o Jim para mim</p>
Essa gravata foi escolhida para mim</p>
David: por um grupo de especialistas</p>
de Tenafly, Nova Jersey,</p>
David: que a escolheram dentre</p>
outras 56 gravatas testadas.</p>
David: Na verdade, a nossa</p>
informação sugere</p>
David: Que eu tenho que ficar com uma gravata</p>
que seja vermelha ou azul.</p>
David: Uma gravata amarela daria impressão de</p>
que eu estaria encarando a minha</p>
situação sem seriedade,</p>
David: e de fato a qualquer instante,</p>
poderia abaixar as calças novamente.</p>
David: Uma de cor prata significaria</p>
que esqueci minhas origens.</p>
David: Os meus sapatos…</p>
David: Vocês sabem, sapatos reluzentes…</p>
David: Associamos a advogados caros</p>
e banqueiros.</p>
David: Se quer os votos dos trabalhadores</p>
David: terá que desgastá-los</p>
um pouco,</p>
David: mas você não pode desgastar muito</p>
David: para não afastar advogados e</p>
banqueiros,</p>
David: pois você precisa deles para bancar</p>
os especialistas em Tenafly.</p>
David: Então, qual é a quantidade</p>
de desgaste ideal?</p>
David: Sabe que pagamos</p>
a um consultor 7.300 dólares…</p>
David: Foram 7.300, Charlie?</p>
Charlie: Legal. Que idiota.</p>
David: 7.300 dólares para um consultor dizer</p>
que esta é a quantidade de desgaste perfeita</p>
Richardson: Ele tem que derramar</p>
o café na camisa às 7:05.</p>
Richardson: Às 7:05, no mais tardar.</p>
Harry: Vou pegá-lo assim que entrar</p>
no parque.</p>
Richardson: Não imagino seguir esse cara</p>
o tempo que você tem feito.</p>
TV: …para tecnologias energéticas</p>
eficientes.</p>
TV: RSR Venture Capital anunciou ontem</p>
TV: que o ex-deputado David Norris</p>
irá tornar-se um sócio sênior.</p>
TV: Norris liderou uma campanha sem</p>
sucesso para o senado no mês passado.</p>
TV: mas seu discurso de derrota foi </p>
considerado por muitos como eletrizante,</p>
TV: e o tornou candidato preferencial</p>
à corrida ao Senado em 2010.</p>
TV: O investidor Charles Traynor,</p>
fundador da RSR,</p>
TV: uma das empresas de capital</p>
de risco mais bem sucedidas do País,</p>
TV: Traynor é amigo de</p>
infância de Norris</p>
TV: e foi coordenador</p>
da campanha.</p>
David: Hey!</p>
Charlie: Hey. Tom Frankel, do "The Journal"</p>
Vai te ligar em 5 minutos.</p>
Charlie: Dei este número.</p>
David: Dê o 3227 pois ainda não estou</p>
habituado a este telefone.</p>
Charlie: Não, eu não posso. Vai perguntar</p>
sobre você se ligar a empresa.</p>
Charlie: Todas as ligações de negócios</p>
devem ser feitas por um Blackberry da empresa.</p>
David: Sério?</p>
Charlie: Sarbanes - Oxley</p>
Charlie: Você votou por isso, amigo.</p>
Na verdade, você co-patrocinou essa</p>
David: Sim, eu me lembro.</p>
David: Ei, eu acabei de ver você na TV.</p>
Charlie: Mesmo?</p>
David: Sim.</p>
Charlie: O que ele disse?</p>
David: Que você é careca.</p>
Charlie: Legal.</p>
David: Sim, foi estranho também,</p>
porque era um programa financeiro.</p>
David: Mas estavam mesmo interessados</p>
nas suas entradas.</p>
Charlie: Tenho de ir, seu idiota.</p>
David: Tchau.</p>
Homem: Deputado.</p>
Homem: Preciso dizer que admiro</p>
o que fez no mês passado.</p>
David: Obrigado, agradeço.</p>
Homem: Eu queria que tivessem</p>
mais políticos como você.</p>
David: Obrigado. Eu me aposentei agora.</p>
David: Tenho de encontrar um</p>
emprego de verdade.</p>
Homem: Você irá bem.</p>
David: Obrigado.</p>
Harry: Ei!</p>
                                    </div>
                                </div>
                        ...
                        <source src="https://videos.universidadedoingles.com.br/yesman/audios/mp3/Ag_Mp_E1_P4.mp3" type="audio/mpeg">
                    </audio>
                            </div>
                        </div>
                    </div>
