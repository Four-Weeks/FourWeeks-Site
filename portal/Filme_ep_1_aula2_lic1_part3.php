  ...
  width: 25px;
    ...
    <body>
        ...
        <div class="menu cor3">
            ...
            <ul class= "nav">
                <li><a href='lista_aulas.php' style="color:#002a80"><h4>Episodio 1 - Aula 2 - Lição 1 - Parte 3</h4></a></li>
                <li style="margin-left:400px;"><h4><a href="Filme_ep_1_aula2_lic1_part2.php"><img  src="img/back.png" style="width:20px;" border="0"></a>Lição 1 - Parte 3 <a href="Filme_ep_1_aula2_lic1_part4.php"> <img  src="img/next-1.png" style="width:20px;" border="0"></a> </h4></li>
...
<video id="video" src="https://videos.universidadedoingles.com.br/agentes/videos/Ag_E1_P3.mp4" ></video>
  </div>
</div>
<script>
...
<INPUT TYPE="hidden" NAME="b1" step="any" value="4.19">

                                      <p> De acordo com a parte do filme acima, escolha a alternativa correta:</p>

                     <ul class="payment-methods">
                <li class="payment-method2 paypal">
                    <input type="radio" name="msg" value="David is participating of a interview."/> <label for="paypal" style="font-size:18px;"> David is participating of a interview. David está participando de uma entrevista.<br /></label>
                    </li>
                    <li class="payment-method2 paypal">
                    <input type="radio" name="msg" value="David is a famous singer."/> <label for="paypal" style="font-size:18px;"> David is a famous singer. David é um cantor famoso.<br /></label>
                        </li>
                    <li class="payment-method paypal">
                    <input type="radio" name="msg" value="David is doing his speech."/> <label for="paypal" style="font-size:18px;"> David is doing his speech. Davis está fazendo seu discurso.<br /></label>
                </li>
