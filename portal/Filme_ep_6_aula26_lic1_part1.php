  ...
  width: 25px;
    ...
    <body>
        ...
        <div class="menu cor3">
            ...
            <ul class= "nav">
                <li><a href='lista_aulas.php' style="color:#002a80"><h4>Episodio 6 - Aula 26 - Lição 1 - Parte 1</h4></a></li>
                <li style="margin-left:400px;"><h4>Lição 1 - Parte 1 <a href="Filme_ep_6_aula26_lic1_part2.php"> <img  src="img/next-1.png" style="width:20px;" border="0"></a> </h4></li>
...
<script>
    $(document).ready(function() {
                   ...
                   <form method="POST" action="mail.php">
                         <INPUT TYPE="hidden" NAME="b1" step="any" value="79.64">


                                             <p> De acordo com a parte do filme acima, escolha a alternativa correta:</p>
                    <ul class="payment-methods">
 <li class="payment-method2 paypal">
                    <input type="radio" name="msg" id="msg" value="David needs a card to open the doors."/><label for="paypal" style="font-size:18px;">David needs a card to open the doors.<br /></label>
                   </li>
                   <li class="payment-method2 paypal"> 
                    <input type="radio"   name="msg" id="msg" value="David needs a key to open the doors."/><label for="paypal" style="font-size:18px;">David needs a key to open the doors. <br /></label>
                    </li>
                    <li class="payment-method paypal">
                    <input type="radio"   name="msg" id="msg" value="David needs a hat to open the doors."/><label for="paypal" style="font-size:18px;"> David needs a hat to open the doors. <br /></label>
                </li>
