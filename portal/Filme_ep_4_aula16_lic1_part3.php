  ...
  width: 25px;
    ...
    <body>
        ...
        <div class="menu cor3">
            ...
            <ul class= "nav">
                <li><a href='lista_aulas.php' style="color:#002a80"><h4>Episodio 4 - Aula 16 - Lição 1 - Parte 3</h4></a></li>
                <li style="margin-left:400px;"><h4><a href="Filme_ep_4_aula16_lic1_part2.php"><img  src="img/back.png" style="width:20px;" border="0"></a>Lição 1 - Parte 3 <a href="Filme_ep_4_aula16_lic1_part4.php"> <img  src="img/next-1.png" style="width:20px;" border="0"></a> </h4></li>
...
<video id="video" src="https://videos.universidadedoingles.com.br/agentes/videos/Ag_E4_P3.mp4" ></video>
  </div>
</div>
<script>
...
<script>
    $(document).ready(function() {
               ...
               <form method="POST" action="mail.php">
                         <INPUT TYPE="hidden" NAME="b1" step="any" value="49.29">

                    <p> De acordo com a parte do filme acima, escolha a alternativa correta:</p>
                    <ul class="payment-methods">
 <li class="payment-method2 paypal">
                    <input type="radio" name="msg" value="Elise is talking about her mother."/> <label for="paypal" style="font-size:18px;">Elise is talking about her mother. Elise está falando sobre a mãe dela. <br /> </label>
                    </li>
                    <li class="payment-method2 paypal">
                    <input type="radio" name="msg" value="Elise is talking about what she likes to eat on breakfast."/> <label for="paypal" style="font-size:18px;">Elise is talking about what she likes to eat on breakfast. Elise está falando sobre o que ela gosta de comer no café da manhã. <br /></label>
                    </li>
                    <li class="payment-method paypal">
                    <input type="radio" name="msg" value="Elise is talking about her ex."/><label for="paypal" style="font-size:18px;">Elise is talking about her ex. Elise está falando sobre seu ex.<br /></label>
                </li>
