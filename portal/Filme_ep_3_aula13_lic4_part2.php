...
<html lang="pt-BR">
    ...
    <body>
        ...
        <div class="menu cor3">
            ...
            <ul class= "nav">
                <li><a href='lista_aulas.php' style="color:#002a80"><h4>Episodio 3 - Aula 13 - Lição 4 - Parte 2</h4></a></li>
                <li style="margin-left:400px;"><h4><a href="Filme_ep_3_aula13_lic4_part1.php"><img  src="img/back.png" style="width:20px;" border="0"></a>Lição 4 - Parte 2 <a href="Filme_ep_3_aula13_lic4_part3.php"> <img  src="img/next-1.png" style="width:20px;" border="0"></a> </h4></li>
...
<script type="text/javascript">
  ...
  function addZero(number){if(number < 10){return "0"+number;}else{return number;}}
        ...
        <!-- SUBMIT -->
                    ...
                    <br>
<!--<iframe width="780" height="415" src="https://www.youtube.com/embed/Rs9TbwyrCto" frameborder="0" allowfullscreen></iframe>
                  -->  <div class="content list" style="background:white;"> 
                        ...
                        <div class="title">
                                            ...
                                            <a href="https://translate.google.com/" target="new">Tradutor</a>
                                                <p align="center">Perguntas indiretas no inglês são definidas por frases que se 
                                                    iniciam com as 4 expressões abaixo:</p>
                         ...
                         <INPUT TYPE="hidden" NAME="b1" step="any" value="42.91">



                        <INPUT TYPE="hidden" NAME="msg" value="Parabéns por mais essa etapa (Aula 13 Lição 4 Parte 2)">
