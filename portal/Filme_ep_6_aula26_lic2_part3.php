...
<html lang="pt-BR">
    ...
    <body>
        ...
        <div class="menu cor3">
            ...
            <ul class= "nav">
                <li><a href='lista_aulas.php' style="color:#002a80"><h4>Episodio 6 - Aula 26 - Lição 2 - Parte 3</h4></a></li>
                <li style="margin-left:400px;"><h4><a href="Filme_ep_6_aula26_lic2_part2.php"><img  src="img/back.png" style="width:20px;" border="0"></a>Lição 2 - Parte 3 <a href="Filme_ep_6_aula26_lic2_part4.php"> <img  src="img/next-1.png" style="width:20px;" border="0"></a> </h4></li>
                            ...
                            <div class="tabbable"> <!-- Only required for left/right tabs -->
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active" id="tab1">
                                        Agent: Hey! You can't be in here.
Agent: Stop! Sir!
Agent: Hold them up!
David: Come on.
Agent: Stop them!
Agent: Harry Mitchell, they want you in the chairman's office.
Agent: Immediately.
David: Come on.
Agent: Hey! Hey!
Agent: How did you get in here?
...
Elise: I love you.
David: I love you.
Thompson: Did you really think you could reach the Chairman?
Thompson: And change your fate
if you did?
Thompson: Or write your own?
Thompson: It doesn't work like that
and I told you why.
Harry: I`ve got a message for you.

                                    </div>
                                    <div class="tab-pane " id="tab2">
Agente: Ei! Você não pode estar aqui.
Agente: Parem! Senhor!
Agente: Detenham-nos!
David: Venha.
Agente: Detenham-nos!
Agente: Harry Mitchell, querem você na sala do Presidente.
Agente: Imediatamente
Davis: Venha.
Agente: Ei! Ei!
Agente: Como entraram aqui ?
Agente: Procurem na sala!
David: Droga!
David: Volte.
Elise: Não.
Elise: Oh, meu Deus.
Elise: Eu te amo.
David: Eu te amo
Thompson: Você achou realmente que poderia chegar ao Presidente?
Thompson: E mudar o seu destino
se conseguisse?
Thompson: Ou escrever seu próprio destino?
Thompson: Não funciona assim
e eu lhe disse o porquê.
Harry: Eu tenho uma mensagem para você.
                        ...
                        <source src="https://videos.universidadedoingles.com.br/yesman/audios/mp3/Ag_E6_A1_P3.mp3" type="audio/mpeg">
                    </audio>
                            </div>
                        </div>
                    </div>
                    ...
                    <form method="POST" action="mail.php">
                         <INPUT TYPE="hidden" NAME="b1" step="any" value="80.96">
                        <INPUT TYPE="hidden" NAME="msg" value="Parabéns por mais essa etapa (Aula 26 Lição 2 Parte 3)">
