...
<html lang="pt-BR">
    ...
    <body>
        ...
        <div class="menu cor3">
            ...
            <ul class= "nav">
                <li><a href='lista_aulas.php' style="color:#002a80"><h4>Episodio 1 - Aula 1 - Lição 4 - Parte 2</h4></a></li>
                <li style="margin-left:400px;"><h4><a href="Filme_ep_1_aula1_lic4_part1.php"><img  src="img/back.png" style="width:20px;" border="0"></a>Lição 4 - Parte 2 <a href="Filme_ep_1_aula1_lic4_part3.php"> <img  src="img/next-1.png" style="width:20px;" border="0"></a> </h4></li>
 ...
 $cS = ($_SG['caseSensitive']) ? 'BINARY' : '';
    ...
    <div class="audio">
      <audio id="player_instrucao">
        <source src="audios/Aula.m4a" type="audio/mpeg">
...
<script type="text/javascript">
  ...
  function addZero(number){if(number < 10){return "0"+number;}else{return number;}}
        ...
        <!-- SUBMIT -->
                    ...
                    <br>
<iframe width="780" height="415" src="https://www.youtube.com/embed/nvVG6qXisxA?rel=0" frameborder="0" allowfullscreen></iframe>
                    ...
                    <form method="POST" action="mail.php">
                        ...
                        <INPUT TYPE="hidden" NAME="b1" step="any" value="3.08">
                        <INPUT TYPE="hidden" NAME="msg" value="Parabéns por mais essa etapa (Aula 1 Lição 4 Parte 2)">
