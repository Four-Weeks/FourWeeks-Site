...
<html lang="pt-BR">
    ...
    <body>
        ...
        <div class="menu cor3">
            ...
            <ul class= "nav">
                <li><a href='lista_aulas.php' style="color:#002a80"><h4>Episodio 6 - Aula 27 - Lição 2 - Parte 3</h4></a></li>
                <li style="margin-left:400px;"><h4><a href="Filme_ep_6_aula27_lic2_part2.php"><img  src="img/back.png" style="width:20px;" border="0"></a>Lição 2 - Parte 3 <a href="Filme_ep_6_aula27_lic2_part4.php"> <img  src="img/next-1.png" style="width:20px;" border="0"></a> </h4></li>
...
Harry: Eu tenho uma mensagem para você.
                    ...
                    <form method="POST" action="mail.php">
                         <INPUT TYPE="hidden" NAME="b1" step="any" value="84.26">
                        <INPUT TYPE="hidden" NAME="msg" value="Parabéns por mais essa etapa (Aula 27 Lição 2 Parte 3)">
