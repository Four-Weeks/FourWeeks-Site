...
<html lang="pt-BR">
    ...
    <body>
        ...
        <div class="menu cor3">
            ...
            <ul class= "nav">
                <li><a href='lista_aulas.php' style="color:#002a80"><h4>Episodio 1 - Aula 2 - Lição 2 - Parte 3</h4></a></li>
                <li style="margin-left:400px;"><h4><a href="Filme_ep_1_aula2_lic2_part2.php"><img  src="img/back.png" style="width:20px;" border="0"></a>Lição 2 - Parte 3 <a href="Filme_ep_1_aula2_lic2_part4.php"> <img  src="img/next-1.png" style="width:20px;" border="0"></a> </h4></li>
...
<INPUT TYPE="hidden" NAME="b1" step="any" value="5.07">
...
<div align="center"><button class="btn btn-primary" type="submit" name="1">AVANÇAR</button></div> 
                                    ...
                                    <div class="tab-pane" id="tab2">
                                      <p> Elise: Foi o meu momento preferido </p>
de toda sua campanha.</p>
David: Mesmo? Eu poderia ter usado você</p>
David: na minha equipe</p>
há uns meses.</p>
Elise: Eu poderia ajudar a pesquisar</p>
Elise: Cada palavra que sai da sua</p>
boca antes de você falar.</p>
David: Oh, você gosta de políticos?</p>
Elise: Eu gosto quando eles fazem</p>
coisas que me eu me identifico.</p>
David: como abaixar as calças?</p>
Elise: Eu adoro isso.</p>
David: Esse tipo de candidato não seria</p>
eleito nem para o grêmio estudantil</p>
Elise: O meu candidato saberia</p>
dar nó na própria gravata.</p>
David: É uma gravata com clip.</p>
Elise: Oh, quem me dera</p>
Elise: teria sido meu outro momento</p>
favorito da sua campanha.</p>
Elise: Ainda tem chance?</p>
Elise: Ou acabou?</p>
David: Ele me derrotou.</p>
Elise: Lamento.</p>
David: Bem, perder tem as suas vantagens</p>
Elise: Como o quê?</p>
David: Por um lado, um político</p>
nunca está sozinho</p>
David: a não ser que esteja</p>
dormindo ou no banheiro,</p>
David: Isso cansa.</p>
Elise: Mesmo?</p>
David: Eu acho que eu</p>
estou ansioso</p>
David: para ter um tempo sozinho.</p>
Elise: Não acredito.</p>
Acho que adora isso.</p>
David: Eu te conheço?</p>
David: Acho que posso</p>
ser mais convincente.</p>
Elise: Okay.</p>
Elise: Não precisa se preocupar</p>
com isso até a próxima eleição.</p>
David: Você é eleitora em Nova York?</p>
Elise: Eu pareço ser?</p>
David: Caramba.</p>
Charlie: David.</p>
Charlie: Oh. Desculpem</p>
Charlie: Desculpe</p>
Elise: Eu tenho de ir.</p>
Elise: Desculpe.</p>
Clarlie: Uau.</p>
David: Espere.</p>
Charlie: Você vai discursar?</p>
David: Espere</p>
David: Ei!</p>
David: Ei!</p>
Segurança: Moça.</p>
Elise: Eu tenho de ir.</p>
Segurança: Moça?</p>
Elise: Assim está bem melhor.</p>
Segurança: Ela está fugindo.</p>
Segurança: Escada sudoeste</p>
Segurança: Com licença? Moça!</p>
Charlie: O que foi isso?</p>
David: Não sei.</p>
Charlie: Você está pronto?</p>
David: Sim, sim.</p>
Charlie: O discurso,</p>
vamos.</p>
Locutor: Congressista David Norris.</p>
David: Cresci não muito longe daqui,</p>
em Red Hook.</p>
Pessoas: Brooklyn!</p>
Eu te amo, David!</p>
Mulher: Eu te amo mais!</p>
David: Eu amo as duas.</p>
David: Tínhamos uma regra no meu bairro.</p>
David: Quando entrávamos numa briga,</p>
David: Não era sobre</p>
apanhar ou não.</p>
David: Mas o que você faz</p>
quando se levanta</p>
David: Vim aqui lhes dizer esta noite</p>
David: que eu irei me reerguer.</p>
David: É mentira.</p>
David: Não tínhamos tal ditado</p>
no meu bairro</p>
David: É apenas uma daquelas</p>
frases que…</p>
David: agradava o</p>
grupo de pesquisa</p>
David: e por isso a usamos,</p>
mas não é verdade.</p>
David: Em 1998 fiz uma</p>
reportagem de capa para a GQ</p>
David: O título era:</p>
O mais jovem deputado de todos os tempos.</p>
David: Desde então, toda matéria tenta explicar</p>
David: como cheguei aqui tão rápido.</p>
David: E a palavra que as pessoas</p>
continuavam usando era “autêntico”.</p>
David: Mas há um problema.</p>
David: Esta gravata nem sequer é minha.</p>
                                    </div>
                                </div>
                                </div>
                            </div>
                        ...
                        <source src="https://videos.universidadedoingles.com.br/yesman/audios/mp3/Ag_Mp_E1_P3.mp3" type="audio/mpeg">
                    </audio>
                            </div>
                        </div>
                    </div>
