 ...
 ul { list-style: none; }
    ...
    <body>
        ...
        <div class="menu cor3">
            ...
            <ul class= "nav">
                <li><a href='lista_aulas.php' style="color:#002a80"><h4>Episodio 3 - Aula 12 - Lição 3 - Parte 3</h4></a></li>
                <li style="margin-left:400px;"><h4><a href="Filme_ep_3_aula12_lic3_part2.php"><img  src="img/back.png" style="width:20px;" border="0"></a>Lição 3 - Parte 3 <a href="Filme_ep_3_aula12_lic3_part4.php"> <img  src="img/next-1.png" style="width:20px;" border="0"></a> </h4></li>
...
{document.getElementById('divTeste').innerHTML = 'Parado...';}
  ...
  <pre id="log" style="visibility:hidden;"></pre>
                         ...
                         <INPUT TYPE="hidden" NAME="b1" step="any" value="38.72">


                                            <INPUT TYPE="hidden" NAME="msg" value="Parabéns por mais essa etapa (Aula 12 Lição 3 Parte 3)">
