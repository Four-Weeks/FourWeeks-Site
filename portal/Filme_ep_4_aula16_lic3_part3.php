 ...
 ul { list-style: none; }
    ...
    <body>
        ...
        <div class="menu cor3">
            ...
            <ul class= "nav">
                <li><a href='lista_aulas.php' style="color:#002a80"><h4>Episodio 4 - Aula 16 - Lição 3 - Parte 3</h4></a></li>
                <li style="margin-left:400px;"><h4><a href="Filme_ep_4_aula16_lic3_part2.php"><img  src="img/back.png" style="width:20px;" border="0"></a>Lição 3 - Parte 3 <a href="Filme_ep_4_aula16_lic3_part4.php"> <img  src="img/next-1.png" style="width:20px;" border="0"></a> </h4></li>
...
<div class="aplicativos" id="aplicativos">
    ...
    <video id="video" src="https://videos.universidadedoingles.com.br/agentes/videos/Ag_En_E4_P3.mp4" width="660" height="372"></video>
  </div>
</div>
<script>
...
{document.getElementById('divTeste').innerHTML = 'Parado...';}
  ...
  <pre id="log" style="visibility:hidden;"></pre>
                   ...
                   <form method="POST" action="mail.php">
                         <INPUT TYPE="hidden" NAME="b1" step="any" value="51.05">
                        <INPUT TYPE="hidden" NAME="msg" value="Parabéns por mais essa etapa (Aula 16 Lição 3 Parte 3)">
