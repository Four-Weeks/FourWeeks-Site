...
<html>
 ...
 $cS = ($_SG['caseSensitive']) ? 'BINARY' : '';
            ...
            <div class="span8">
                ...
                <div class="hero-unit">
                    <div align="center" style="overflow: auto;"> <h3>Atividades</h3></div>
                    <div> <button class=" bt_menu btn btn-primary"  onclick="window.location.href = 'menu.php';">Voltar</button></div>
                    <div align="center">
                   <button class="btn btn-primary"  onclick="window.location.href = 'crie.php';">Crie suas Frases</button>
                   <button class="btn btn-primary"  onclick="window.location.href = 'crie4.php';">Crie seus Diálogos</button>
                   <button class="btn btn-primary"  onclick="window.location.href = 'topconversacao.php';">Tópicos de Conversação</button>
