...
<html lang="pt-BR">
    ...
    <body>
        ...
        <div class="menu cor3">
            ...
            <ul class= "nav">
                <li><a href='lista_aulas.php' style="color:#002a80"><h4>Episodio 1 - Aula 1 - Lição 4 - Parte 4</h4></a></li>
                <li style="margin-left:400px;"><h4><a href="Filme_ep_1_aula1_lic4_part3.php"><img  src="img/back.png" style="width:20px;" border="0"></a>Lição 4 - Parte 4 <a href="Filme_ep_1_aula1_lic5_part1.php"> <img  src="img/next-1.png" style="width:20px;" border="0"></a> </h4></li>
        ...
        <!-- SUBMIT -->
                    ...
                    <div class="content list" style="background:white;"> 
                       ...
                       <div class="title"><div align="center" style="color:red">Diálogo 1 - Apresentando-se</div> 
                                            ...
                                            <p>Por exemplo:</p>
                                            <p>A: Hi, I am Cléber!</p>
                                            <p>B: Hello, I am Maria, you are a nice guy.</p>
                                            <br>
                                            
                                            <br>
                                            <div align='center'>
                                                <form method="POST" action="mail.php">
                                                    <INPUT TYPE="hidden" NAME="b1" step="any" value="3.52">
