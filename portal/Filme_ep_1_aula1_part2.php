  ...
  width: 25px;
    ...
    <body>
        ...
        <div class="menu cor3">
            ...
            <ul class= "nav">
                <li><a href='lista_aulas.php' style="color:#002a80"><h4>Episodio 1 - Aula 1 - Lição 1 - Parte 2</h4></a></li>
                <li style="margin-left:400px;"><h4><a href="Filme_ep_1_aula1_part1.php"><img  src="img/back.png" style="width:20px;" border="0"></a>Lição 1 - Parte 2 <a href="Filme_ep_1_aula1_part3.php"> <img  src="img/next-1.png" style="width:20px;" border="0"></a> </h4></li>
...
<video id="video" src="https://videos.universidadedoingles.com.br/agentes/videos/Ag_E1_P2.mp4" ></video>
  </div>
</div>
<script>
...
<script>
    ...
    <form method="POST" action="mail.php">
                    <INPUT TYPE="hidden" NAME="b1" step="any" value="0.44">
                    <p> De acordo com a parte do filme acima, escolha a alternativa correta:</p>

                     <ul class="payment-methods">
 <li class="payment-method2 paypal">
                    <input type="radio" name="msg" value=" He is happy because he is the winner of the election."/>  <label for="paypal" style="font-size:18px;">He is happy because he is the winner of the election. Ele está feliz por ser o vencedor da eleição.<br /> </label>
                    </li>
 <li class="payment-method2 paypal">
                    <input type="radio" name="msg" value="He is watching a game in Tv. "/> <label for="paypal" style="font-size:18px;">He is watching a game in Tv. Ele está assistindo um jogo na Tv.<br /> </label>
                    </li>
 <li class="payment-method paypal">
                    <input type="radio" name="msg" value="He is rehearsing his speech at the restroom. "/> <label for="paypal" style="font-size:18px;">He is rehearsing his speech at the restroom. Ele está ensaiando seu discurso no banheiro. <br /> </label>
                </li>
