  ...
  width: 25px;
    ...
    <body>
        ...
        <div class="menu cor3">
            ...
            <ul class= "nav">
                <li><a href='lista_aulas.php' style="color:#002a80"><h4>Episodio 1 - Aula 1 - Lição 1 - Parte 1</h4></a></li>
                <li style="margin-left:400px;"><h4>Lição 1 - Parte 1 <a href="Filme_ep_1_aula1_part2.php"> <img  src="img/next-1.png" style="width:20px;" border="0"></a> </h4></li>
...
<script>
    $(document).ready(function() {
                   ...
                   <form method="POST" action="mail.php">
                    <INPUT TYPE="hidden" NAME="b1" step="any" value="0.22">
...
<br><br><br>
 ...
 <li class="payment-method2 paypal">
                    <input type="radio"   name="msg" id="msg" value="David Norris is playing piano"/> <label for="paypal" style="font-size:18px;">David Norris is playing piano. David Norris está tocando piano.</label>
                  </li> 
                  <li class="payment-method paypal"> 
                    <input type="radio"   name="msg" id="msg" value="David Norris is participating in a Political campaign. "/> <label for="paypal" style="font-size:18px;"> David Norris is participating in a Political campaign. David Norris está participando de uma campanha eleitoral</label>
                    </li>
                    <li class="payment-method2 paypal">
                    <input type="radio"   name="msg" id="msg" value="David Norris is a Reporter. "/> <label for="paypal" style="font-size:18px;"> David Norris is a Reporter. David Norris é um repórter. </label>
</li>
</ul>
