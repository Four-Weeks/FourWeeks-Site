...
<html lang="pt-BR">
    ...
    <body>
        ...
        <div class="menu cor3">
            ...
            <ul class= "nav">
                <li><a href='lista_aulas.php' style="color:#002a80"><h4>Episodio 5 - Aula 24 - Lição 1 - Parte 4</h4></a></li>
                <li style="margin-left:400px;"><h4><a href="Filme_ep_5_aula24_lic1_part3.php"><img  src="img/back.png" style="width:20px;" border="0"></a>Lição 1 - Parte 4 <a href="Filme_ep_5_aula24_lic2_part1.php"> <img  src="img/next-1.png" style="width:20px;" border="0"></a> </h4></li>
 ...
 $cS = ($_SG['caseSensitive']) ? 'BINARY' : '';
    ...
    <div class="audio">
      <audio id="player_instrucao">
        <source src="audios/oqueentendeu.m4a" type="audio/mpeg">
...
<video id="video" src="https://videos.universidadedoingles.com.br/agentes/videos/Ag_En_E5_P4.mp4" ></video>
  </div>
</div>
<script>
...
<script>
    ...
    <form method="POST" action="mail.php">
                         <INPUT TYPE="hidden" NAME="b1" step="any" value="75.90">
                     <p>Escreva o que entendeu do trecho do filme usando o seu vocabulário em inglês:</p>
