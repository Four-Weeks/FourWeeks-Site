  ...
  width: 25px;
    ...
    <body>
        ...
        <div class="menu cor3">
            ...
            <ul class= "nav">
                <li><a href='lista_aulas.php' style="color:#002a80"><h4>Episodio 2 - Aula 6 - Lição 1 - Parte 2</h4></a></li>
                <li style="margin-left:400px;"><h4><a href="Filme_ep_2_aula6_lic1_part1.php"><img  src="img/back.png" style="width:20px;" border="0"></a>Lição 1 - Parte 2 <a href="Filme_ep_2_aula6_lic1_part3.php"> <img  src="img/next-1.png" style="width:20px;" border="0"></a> </h4></li>
...
<video id="video" src="https://videos.universidadedoingles.com.br/agentes/videos/Ag_E2_P2.mp4" ></video>
  </div>
</div>
<script>
...
<script>
    $(document).ready(function() {
         ...
         <form method="POST" action="mail.php">
                         <INPUT TYPE="hidden" NAME="b1" step="any" value="16.72">
                    <p> De acordo com a parte do filme acima, escolha a alternativa correta:</p>
                     <ul class="payment-methods">
 <li class="payment-method paypal">
                    <input type="radio" name="msg" value=" Everybody is frozen when David arrives at the office"/><label for="paypal" style="font-size:18px;"> Everybody is frozen when David arrives at the office. Todo mundo está congelado quando David chega ao escritório..<br /> </label>
                    </li>
                    <li class="payment-method2 paypal">
                    <input type="radio" name="msg" value="Everybody is working when David arrives at the office"/><label for="paypal" style="font-size:18px;"> Everybody is working when David arrives at the office. Todo mundo está trabalhando quando David chega ao escritório.<br /></label>
                   </li>
                   <li class="payment-method2 paypal">
                    <input type="radio" name="msg" value="The agents are trying to help David. "/><label for="paypal" style="font-size:18px;"> The agents are trying to help David. Os agentes estão tentando ajudar o David.<br /></label>
</li>
</ul>
