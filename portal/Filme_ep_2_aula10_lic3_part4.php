...
<html lang="pt-BR">
    ...
    <body>
        ...
        <div class="menu cor3">
            ...
            <ul class= "nav">
                <li><a href='lista_aulas.php' style="color:#002a80"><h4>Episodio 2 - Aula 10 - Lição 3 - Parte 4</h4></a></li>
                <li style="margin-left:400px;"><h4><a href="Filme_ep_2_aula10_lic3_part3.php"><img  src="img/back.png" style="width:20px;" border="0"></a>Lição 3 - Parte 4 <a href="Filme_ep_2_aula10_lic4_part1.php"> <img  src="img/next-1.png" style="width:20px;" border="0"></a> </h4></li>
        ...
        <!-- SUBMIT -->
                    ...
                    <div class="content list" style="background:white;"> 
                       ...
                       <div class="title"><div align="center" style="color:red">Diálogo 10 - Entrevista de Emprego</div> 
                                            ...
                                            <p>Por exemplo:</p>
                                            <p>A: Why do you want Work here?</p>
                                            <p>B: Because this is the best company to work.</p>
                         ...
                         <INPUT TYPE="hidden" NAME="b1" step="any" value="31.91">
