...
<html lang="pt-BR">
    ...
    <body>
        ...
        <div class="menu cor3">
            ...
            <ul class= "nav">
                <li><a href='lista_aulas.php' style="color:#002a80"><h4>Episodio 1 - Aula 1 - Lição 5 - Parte 1</h4></a></li>
                <li style="margin-left:400px;"><h4><a href="Filme_ep_1_aula1_lic4_part4.php"><img  src="img/back.png" style="width:20px;" border="0"></a>Lição 5 - Parte 1 <a href="Filme_ep_1_aula2_lic1_part1.php"> <img  src="img/next-1.png" style="width:20px;" border="0"></a> </h4></li>
 ...
 $cS = ($_SG['caseSensitive']) ? 'BINARY' : '';
         ...
         <form  method="POST" action="mail.php">  
            ...
            <INPUT TYPE="hidden" NAME="b1" step="any" value="3.74">
