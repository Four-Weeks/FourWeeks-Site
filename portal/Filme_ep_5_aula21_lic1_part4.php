  ...
  width: 25px;
    ...
    <body>
        ...
        <div class="menu cor3">
            ...
            <ul class= "nav">
                <li><a href='lista_aulas.php' style="color:#002a80"><h4>Episodio 5 - Aula 21 - Lição 1 - Parte 4</h4></a></li>
                <li style="margin-left:400px;"><h4><a href="Filme_ep_5_aula21_lic1_part3.php"><img  src="img/back.png" style="width:20px;" border="0"></a>Lição 1 - Parte 4 <a href="Filme_ep_5_aula21_lic2_part1.php"> <img  src="img/next-1.png" style="width:20px;" border="0"></a> </h4></li>
...
<script>
    ...
    <form method="POST" action="mail.php">
                         <INPUT TYPE="hidden" NAME="b1" step="any" value="65.34">


                                             <p> De acordo com a parte do filme acima, escolha a alternativa correta:</p>
                    <ul class="payment-methods">
 <li class="payment-method2 paypal">
                    <input type="radio" name="msg" value="Harry doesn't help David about the doors. "/> <label for="paypal" style="font-size:18px;"> Harry doesn't help David about the doors. Harry não ajuda David sobre as portas.<br /></label>
                    </li>
                    <li class="payment-method2 paypal">
                    <input type="radio" name="msg" value="Harry is explaining David about Elise's presentation. "/> <label for="paypal" style="font-size:18px;"> Harry is explaining David about Elise's presentation. Harry está explicando para David sobre a apresentação de Elise.<br /></label>
                    </li>
                    <li class="payment-method paypal">
                    <input type="radio" name="msg" value="Harry is explaining David about the doors. "/> <label for="paypal" style="font-size:18px;">Harry is explaining David about the doors. Harry está explicando para David sobre as portas. <br/> </label>
                     </li>
                 </ul>
