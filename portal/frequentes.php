...
<html>
    <head>
        ...
        <meta name="description" content="Professores de Conversação"/>
 ...
 $cS = ($_SG['caseSensitive']) ? 'BINARY' : '';
            ...
            <div class="span8">
                ...
                <div class="hero-unit">
                    <div align="center" style="overflow: auto;"> <h3>Dúvidas Frequentes</h3></div>
                    <div> <button class=" bt_menu btn btn-primary"  onclick="window.location.href = 'menu.php';">Voltar</button></div>
                    <br>
                    <div class="tabbable tabs-left">
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="#tab1" data-toggle="tab" style="color:#5a5a5a">Perg. 1</a></li>
                            <li><a href="#tab2" data-toggle="tab" style="color:#5a5a5a">Perg. 2</a></li>
                             <li><a href="#tab3" data-toggle="tab" style="color:#5a5a5a">Perg. 3</a></li>
                              <li><a href="#tab4" data-toggle="tab" style="color:#5a5a5a">Perg. 4</a></li>
                               <li><a href="#tab5" data-toggle="tab" style="color:#5a5a5a">Perg. 5</a></li>
                        </ul>
                        <div class="tab-content">
                            <div class="tab-pane active" id="tab1">
                                <p style="font-size: 21px;color:#039">Terei aulas com professor?</p>
                                <br>
                                <div style="color:#000">
                                <p>O portal foi desenvolvido para que você possa aprender inglês sozinho, entretanto, você possui área de suporte para tirar suas dúvidas</p>
                                </div>
                            </div>
                            <div class="tab-pane" id="tab2">
                                <p style="font-size: 21px;color:#039">Quanto tempo demoro para completar as atividades propostas?</p>
                                <br>
                                <div style="color:#000">
                                <p>Cerca de 1 hora e 30 min.</p>
                                </div>
                            </div>
                            <div class="tab-pane" id="tab3">
                                <p style="font-size: 21px;color:#039">Em quanto tempo consigo falar inglês?</p>
                                <br>
                                <div style="color:#000">
                                <p>Se realizar todas as tarefas com empenho e dedicação, tirando todas as dúvidas
                                 e escutando os concertos de manhã, tarde e noite em 4 semanas já terá a fluência.</p>
                                </div>
                            </div>
                            <div class="tab-pane" id="tab4">
                                <p style="font-size: 21x;color:#039">Para onde são enviadas as atividades?</p>
                                <br>
                                <div style="color:#000">
                                <p>Para o seu email de cadastro</p>
                                </div>
                            </div>
