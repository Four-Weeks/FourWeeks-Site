  ...
  width: 25px;
    ...
    <body>
        ...
        <div class="menu cor3">
            ...
            <ul class= "nav">
                <li><a href='lista_aulas.php' style="color:#002a80"><h4>Episodio 5 - Aula 21 - Lição 1 - Parte 3</h4></a></li>
                <li style="margin-left:400px;"><h4><a href="Filme_ep_5_aula21_lic1_part2.php"><img  src="img/back.png" style="width:20px;" border="0"></a>Lição 1 - Parte 3 <a href="Filme_ep_5_aula21_lic1_part4.php"> <img  src="img/next-1.png" style="width:20px;" border="0"></a> </h4></li>
...
<video id="video" src="https://videos.universidadedoingles.com.br/agentes/videos/Ag_E5_P3.mp4" ></video>
  </div>
</div>
<script>
...
<script>
    $(document).ready(function() {
               ...
               <form method="POST" action="mail.php">
                         <INPUT TYPE="hidden" NAME="b1" step="any" value="65.12">

                    <p> De acordo com a parte do filme acima, escolha a alternativa correta:</p>
                    <ul class="payment-methods">
 <li class="payment-method paypal">
                    <input type="radio" name="msg" value="Harry is explaining to David about his family."/> <label for="paypal" style="font-size:18px;">Harry is explaining to David about his family. Harry está explicando para David sobre a família dele.<br /> </label>
                    </li>
                    <li class="payment-method2 paypal">
                    <input type="radio" name="msg" value="David receives a message during the speech."/> <label for="paypal" style="font-size:18px;">David receives a message during the speech. David recebe uma mensagem durante o discurso.<br /></label>
                    </li>
                    <li class="payment-method2 paypal">
                    <input type="radio" name="msg" value="Harry doesn't mention David's family."/><label for="paypal" style="font-size:18px;">Harry doesn't mention David's family. Harry não fala sobre a família de David<br /></label>
                </li>
