...
<html lang="pt-BR">
    ...
    <body>
        ...
        <div class="menu cor3">
            ...
            <ul class= "nav">
                <li><a href='lista_aulas.php' style="color:#002a80"><h4>Episodio 1 - Aula 4 - Lição 2 - Parte 4</h4></a></li>
                <li style="margin-left:400px;"><h4><a href="Filme_ep_1_aula4_lic2_part3.php"><img  src="img/back.png" style="width:20px;" border="0"></a>Lição 2 - Parte 4 <a href="Filme_ep_1_aula4_lic3_part1.php"> <img  src="img/next-1.png" style="width:20px;" border="0"></a> </h4></li>
        ...
        <!-- SUBMIT -->
                    ...
                    <div class="content list" style="background:white;"> 
                       ...
                       <div class="title"><div align="center" style="color:red">Diálogo 4 - Indo ao Supermercado</div> 
                                            ...
                                            <p>Por exemplo:</p>
                                            <p>A: Good afternoon, Monica</p>
                                            <p>B: Good afternoon, Lucas, where are you going?</p>
                                            <p>A: On supermarket.</p>
                                            <br>
                         ...
                         <INPUT TYPE="hidden" NAME="b1" step="any" value="12.98">
