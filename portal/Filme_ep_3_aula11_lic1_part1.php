  ...
  width: 25px;
    ...
    <body>
        ...
        <div class="menu cor3">
            ...
            <ul class= "nav">
                <li><a href='lista_aulas.php' style="color:#002a80"><h4>Episodio 3 - Aula 11 - Lição 1 - Parte 1</h4></a></li>
                <li style="margin-left:400px;"><h4>Lição 1 - Parte 1 <a href="Filme_ep_3_aula11_lic1_part2.php"> <img  src="img/next-1.png" style="width:20px;" border="0"></a> </h4></li>
...
<video id="video" src="https://videos.universidadedoingles.com.br/agentes/videos/Ag_E3_P1.mp4" ></video>
  </div>
</div>
<script>
...
<script>
    $(document).ready(function() {
                    ...
                    <form method="POST" action="mail.php">
                         <INPUT TYPE="hidden" NAME="b1" step="any" value="32.78">


                                     <p> De acordo com a parte do filme acima, escolha a alternativa correta:</p>
                    <ul class="payment-methods">
 <li class="payment-method2 paypal">
                    <input type="radio" name="msg" id="msg" value="David and Harry are talking about the election"/><label for="paypal" style="font-size:18px;"> David and Harry are talking about the election. David e Harry estão falando sobre a eleição.<br /></label>
                   </li>
                   <li class="payment-method paypal"> 
                    <input type="radio"   name="msg" id="msg" value="David and Harry are talking about the agents."/><label for="paypal" style="font-size:18px;"> David and Harry are talking about the agents. David e Harry estão falando sobre os agentes.<br /></label>
                    </li>
                    <li class="payment-method2 paypal">
                    <input type="radio"   name="msg" id="msg" value="David and Harry are talking about David´s job."/><label for="paypal" style="font-size:18px;"> David and Harry are talking about David´s job. David e Harry estão falando sobre o trabalho de David. <br /></label>
                </li>
