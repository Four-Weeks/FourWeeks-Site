...
<html lang="pt-BR">
    ...
    <body>
        ...
        <div class="menu cor3">
            ...
            <ul class= "nav">
                <li><a href='lista_aulas.php' style="color:#002a80"><h4>Episodio 5 - Aula 22 - Lição 2 - Parte 1</h4></a></li>
                <li style="margin-left:400px;"><h4><a href="Filme_ep_5_aula22_lic1_part4.php"><img  src="img/back.png" style="width:20px;" border="0"></a>Lição 2 - Parte 1 <a href="Filme_ep_5_aula22_lic2_part2.php"> <img  src="img/next-1.png" style="width:20px;" border="0"></a> </h4></li>
...
Thompson: There is one more piece
to this I haven't mentioned.
Thompson: I guess I just didn't have the heart.
Thompson: If you stay with her,
Thompson: it not only kills your dreams,
it kills hers.
David: What?
Thompson: Elise is about to become one of
the most famous dancers in the country
Thompson: and eventually one of the
world's greatest choreographers.
Thompson: If she stays with you,
Thompson: she ends up teaching
dance to six-year-olds.
Thompson: When you look back at all this, David,
Thompson: just remember
Thompson: we tried to reason with you.
Thompson: I always hear people saying
Thompson: "You can't blame yourself
for what happens to other people,"
Thompson: but in this case,
really, you can.
Thompson: This is what you do, David.
Thompson: This is what you did getting
into a bar fight
Thompson: the night you first got elected.
Thompson: What you did to get that embarrassing
photo in The New York Post.
Thompson: We give you opportunities
other people would kill for
Thompson: and you squander them
with impulse.
Thompson: It doesn't take
a genius to see Elise
Thompson: isn't exactly helping you with this.
Thompson: It's a sprain, David,
...
Thompson: Há mais uma parte
que eu não mencionei.
Thompson: Acho que não tive coragem.
Thompson: Se você ficar com ela,
Thompson: não destruirá só os seus sonhos,
mas também os dela.
David: O que?
Thompson: Elise está para se tornar uma
das maiores bailarinas do país
Thompson: e eventualmente, uma das maiores
coreógrafas mundiais.
Thompson: Se ela ficar com você,
Thompson: ela acabará ensinando dança
para crianças de 6 anos.
Thompson: Quando olhar para trás, David,
Thompson: apenas lembre-se
Thompson: de que tentamos avisá-lo.
Thompson: Sempre ouço:
Thompson: "Não pode se culpar pelo
que acontece aos outros."
Thompson: mas nesse caso realmente,
você pode.
Thompson: É isso o que você faz, David.
Thompson: Isso foi o que você fez
entrando em uma briga num bar
Thompson: na noite que foi eleito.
Thompson: O que fez para ter aquela foto
constrangedora no New York Post.
Thompson: Demos a você chances que outros
matariam para ter,
Thompson: e você as desperdiça
com impulso.
Thompson: Não precisa ser gênio
para ver que Elise
Thompson: não está exatamente te ajudando com isso.
Thompson: É uma torção, David
                                    </div>
                                </div>
                                </div>
                            </div>
                        ...
                        <source src="https://videos.universidadedoingles.com.br/yesman/audios/mp3/Ag_E5_A1_P1.mp3" type="audio/mpeg">
                    </audio>
                            </div>
                        </div>
                    </div>
                        ...
                        <form method="POST" action="mail.php">
                         <INPUT TYPE="hidden" NAME="b1" step="any" value="69.08">


                                        <INPUT TYPE="hidden" NAME="msg" value="Parabéns por mais essa etapa (Aula 22 Lição 2 Parte 1)">
