...
<html lang="pt-BR">
    ...
    <body>
        ...
        <div class="menu cor3">
            ...
            <ul class= "nav">
                <li><a href='lista_aulas.php' style="color:#002a80"><h4>Episodio 1 - Aula 5 - Lição 3 - Parte 4</h4></a></li>
                <li style="margin-left:400px;"><h4><a href="Filme_ep_1_aula5_lic3_part3.php"><img  src="img/back.png" style="width:20px;" border="0"></a>Lição 3 - Parte 4 <a href="Filme_ep_1_aula5_lic4_part1.php"> <img  src="img/next-1.png" style="width:20px;" border="0"></a> </h4></li>
        ...
        <!-- SUBMIT -->
                    ...
                    <div class="content list" style="background:white;"> 
                       ...
                       <div class="title"><div align="center" style="color:red">Diálogo 5 - Indo ao cinema</div> 
                                            ...
                                            <p>Por exemplo:</p>
                                            <p>A: Hi Pablo, how are you?</p>
                                            <p>B: Fine, thanks, and you?</p>
                                            <p>A: Fine too, let's go to the cinema?</p>
                                            <p>B: Of course<p>
                         ...
                         <INPUT TYPE="hidden" NAME="b1" step="any" value="15.84">
