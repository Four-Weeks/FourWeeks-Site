   ...
   /* GLOBAL STYLES
    ...
    <body>
        ...
        <div class="menu cor3">
            ...
            <ul class= "nav">
                <li><a href='lista_aulas.php' style="color:#002a80"><h4>Episodio 2 - Aula 7 - Lição 1 - Parte 3</h4></a></li>
                <li style="margin-left:400px;"><h4><a href="Filme_ep_2_aula7_lic1_part2.php"><img  src="img/back.png" style="width:20px;" border="0"></a>Lição 1 - Parte 3 <a href="Filme_ep_2_aula7_lic1_part4.php"> <img  src="img/next-1.png" style="width:20px;" border="0"></a> </h4></li>
...
<video id="video" src="https://videos.universidadedoingles.com.br/agentes/videos/Ag_E2_P3.mp4" ></video>
  </div>
</div>
<script>
...
<script>
    $(document).ready(function() {
         ...
         <form method="POST" action="mail.php">
                         <INPUT TYPE="hidden" NAME="b1" step="any" value="20.68">

                    <p> De acordo com a parte do filme acima, escolha a alternativa correta:</p>
                    <ul class="payment-methods">
 <li class="payment-method paypal">
                    <input type="radio" name="msg" value="The agents burns Elise´s phone number."/><label for="paypal" style="font-size:18px;">The agents burns Elise´s phone number. Os agentes queimam o número de telefone da Elise.<br /> </label>
                    </li>
                    <li class="payment-method2 paypal">
                    <input type="radio" name="msg" value="David´s friend finds him at the restroom."/> <label for="paypal" style="font-size:18px;">David´s friend finds him at the restroom. O amigo do David encontra ele no banheiro.<br /></label>
                    </li>
                    <li class="payment-method2 paypal">
                    <input type="radio" name="msg" value="David talks a lot during the work meeting."/><label for="paypal" style="font-size:18px;"> David talks a lot during the work meeting. David fala muito durante a reunião no trabalho. <br /></label>
                </li>
            </ul>
