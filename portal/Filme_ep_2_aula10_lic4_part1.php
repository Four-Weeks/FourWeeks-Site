 ...
 ul { list-style: none; }
    ...
    <body>
        ...
        <div class="menu cor3">
            ...
            <ul class= "nav">
                <li><a href='lista_aulas.php' style="color:#002a80"><h4>Episodio 2 - Aula 10 - Lição 4 - Parte 1</h4></a></li>
                <li style="margin-left:400px;"><h4><a href="Filme_ep_2_aula10_lic3_part4.php"><img  src="img/back.png" style="width:20px;" border="0"></a>Lição 4 - Parte 1 <a href="Filme_ep_2_aula10_lic4_part2.php"> <img  src="img/next-1.png" style="width:20px;" border="0"></a> </h4></li>
...
<h2>Gravações</h2>
  ...
  <p style="margin-left:500px;">How do you see yourself in 5 five years?</p>
  ...
  <p>What college did you do or intend to do?</p>
  <button onclick="startRecording(this);insereTexto()" style="margin-left:100px; border-width:0px;border-radius:100px;background-color:rgba(44, 44, 49, 0.4);"><img src="img/gravador.png" style="width:38px;"></button>
  <button onclick="stopRecording(this); TrocaTexto()" style=" border-width:0px;border-radius:100px; background-color:rgba(44, 44, 49, 0.4);" disabled><img src="img/stop.png" style="width:40px;"></button>
 
   <p style="margin-left:500px;">What country would you like to visit?</p>
  <button onclick="startRecording(this); insereTexto()" style="margin-left:600px; border-width:0px;border-radius:100px;background-color:rgba(44, 44, 49, 0.4);"><img src="img/gravador.png" style="width:38px;"></button>
  <button onclick="stopRecording(this); TrocaTexto()" style=" border-width:0px;border-radius:100px; background-color:rgba(44, 44, 49, 0.4);" disabled><img src="img/stop.png" style="width:40px;"></button>
 ...
 <p style="margin-left:500px;">What is necessary to get sucess on the life?</p>
  <button onclick="startRecording(this);insereTexto()" style="margin-left:600px; border-width:0px;border-radius:100px;background-color:rgba(44, 44, 49, 0.4);"><img src="img/gravador.png" style="width:38px;"></button>
  <button onclick="stopRecording(this); TrocaTexto()" style=" border-width:0px;border-radius:100px; background-color:rgba(44, 44, 49, 0.4);" disabled><img src="img/stop.png" style="width:40px;"></button>
  ...
  <pre id="log" style="visibility:hidden;"></pre>
                   ...
                   <form method="POST" action="mail.php">
                         <INPUT TYPE="hidden" NAME="b1" step="any" value="32.13">


                                                 <INPUT TYPE="hidden" NAME="msg" value="Parabéns por mais essa etapa (Aula 1 Lição 3 Parte 1)">
