...
<html lang="pt-BR">
    ...
    <body>
        ...
        <div class="menu cor3">
            ...
            <ul class= "nav">
                <li><a href='lista_aulas.php' style="color:#002a80"><h4>Episodio 2 - Aula 6 - Lição 2 - Parte 2</h4></a></li>
                <li style="margin-left:400px;"><h4><a href="Filme_ep_2_aula6_lic2_part1.php"><img  src="img/back.png" style="width:20px;" border="0"></a>Lição 2 - Parte 2 <a href="Filme_ep_2_aula6_lic2_part3.php"> <img  src="img/next-1.png" style="width:20px;" border="0"></a> </h4></li>
...
David: Oh.</p>
         ...
         <form method="POST" action="mail.php">
                         <INPUT TYPE="hidden" NAME="b1" step="any" value="17.39">
                        <INPUT TYPE="hidden" NAME="msg" value="Parabéns por mais essa etapa (Aula 6 Lição 2 Parte 2)">
