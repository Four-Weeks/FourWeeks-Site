...
<html lang="pt-BR">
    ...
    <body>
        ...
        <div class="menu cor3">
            ...
            <ul class= "nav">
                <li><a href='lista_aulas.php' style="color:#002a80"><h4>Episodio 4 - Aula 16 - Lição 2 - Parte 1</h4></a></li>
                <li style="margin-left:400px;"><h4><a href="Filme_ep_4_aula16_lic1_part4.php"><img  src="img/back.png" style="width:20px;" border="0"></a>Lição 2 - Parte 1 <a href="Filme_ep_4_aula16_lic2_part2.php"> <img  src="img/next-1.png" style="width:20px;" border="0"></a> </h4></li>
...
with a flick of his hand
                                    ...
                                    Agente: Temos pontos de desvio.
Agente: Ele só precisa ver a dança
e atingir o limite de onda.
Richardson: O quê? Tudo bem,
bloqueie a porta.
Agente: Ele já está lá.
Richardson: Não aquela, a seguinte.
David: Com licença.
David: David Norris, estou aqui para ver Elise.
Richardson: Estou bloqueando todas elas.
Agente: Chapéu! Chapéu!
David Ela está aqui?
Mulher: Sim, no estúdio.
Richardson: É tarde demais.
Ele já a viu.
Richardson: Você atingiu seu limite de onda.
Richardson: Pode comemorar agora.
Richardson: Isso vai chegar à chefia.
Agente: É o Donaldson.
Richardson: Ele não sabe contra o que está lutando.
Donaldson: Vamos dar uma volta.
Donaldson: A intensa química entre eles,
Donaldson: os constantes pontos de desvio,
Donaldson: E pra terminar, os
separaram 2 vezes
Donaldson: Só para ter a chance de uni-los novamente.
Donaldson: Sim, tudo parece um pouco demais.
Donaldson: Então, pedi a Burdensky que fizesse
uma pesquisa nesta manhã.
Donaldson: Já esteve aqui antes?
Donaldson: Não, é claro que não.
Agente: Parece que David Norris
e Elise Sellas
Agente: deveriam ficar juntos
Agente: porque tinha de ser assim.
Richardson: Espere. O quê?
Donaldson: Nos anos 70, quando ele nasceu,
Donaldson: era para ficarem juntos,
Donaldson: o mesmo nos anos 80, nos 90..
Agente: Só em 2005, quando o plano mudou,
Agente: ela deveria ficar com Adrian.
Agente: O problema é que há resquícios
dos antigos planos
Agente: que continuam unindo-os.
Agente: Eles ainda acham que pertencem
um ao outro, mesmo que não
Agente: e vamos separá-los de novo.
Richardson: Passou sua carreira inteira,
Richardson: esperando um dia
pegar um caso de destaque.
Richardson: Algo para construir seu nome.
Richardson: Finalmente consegue um,
Richardson: e é uma armadilha.
Harry: Como?
Richardson: Estou dizendo que não foi sua culpa.
Richardson: Eles foram feitos para ficarem juntos.
Harry: Como?
Richardson: Deviam, em uma versão anterior do plano.
Richardson: Na verdade, em uma dúzia
de versões anteriores.
Richardson: Sempre me perguntei
como fomos azarados
Richardson: por ela estar naquele ônibus,
naquele dia específico.
Harry: Como o plano pôde mudar assim?
Richardson: Não sei.
Richardson: Está fora da minha alçada.
Agente: Então vamos iniciar uma operação.
Agente: Que ótimo. Já faz algum tempo.
Donaldson: Não vamos iniciar operação.
Donaldson: Ninguém chega onde estou
correndo riscos estúpidos.
Agente: Então o que vamos fazer?
Donaldson: Vamos manter este caso no alto escalão,
Donaldson: com alguém que possa
limpar essa bagunça
Donaldson: sem derramar uma gota de suor.
Donaldson: Vamos levar isto ao Thompson.
Agente: Thompson?
Agente: Quando ele estava em campo.
Seu apelido era…
Donaldson: “O Martelo”, sim.
Donaldson: Ele vai acabar com este romance
com uma mão.
                                    </div>
                                </div>
                                </div>
                        ...
                        <source src="https://videos.universidadedoingles.com.br/yesman/audios/mp3/Ag_Mp_E4_P1.mp3" type="audio/mpeg">
                    </audio>
                            </div>
                        </div>
                    </div>
                        ...
                        <form method="POST" action="mail.php">
                         <INPUT TYPE="hidden" NAME="b1" step="any" value="49.73">


                                        <INPUT TYPE="hidden" NAME="msg" value="Parabéns por mais essa etapa (Aula 16 Lição 2 Parte 1)">
