  ...
  width: 25px;
    ...
    <body>
        ...
        <div class="menu cor3">
            ...
            <ul class= "nav">
                <li><a href='lista_aulas.php' style="color:#002a80"><h4>Episodio 2 - Aula 7 - Lição 1 - Parte 4</h4></a></li>
                <li style="margin-left:400px;"><h4><a href="Filme_ep_2_aula7_lic1_part3.php"><img  src="img/back.png" style="width:20px;" border="0"></a>Lição 1 - Parte 4 <a href="Filme_ep_2_aula7_lic2_part1.php"> <img  src="img/next-1.png" style="width:20px;" border="0"></a> </h4></li>
...
<script>
    $(document).ready(function() {
         ...
         <form method="POST" action="mail.php">
                         <INPUT TYPE="hidden" NAME="b1" step="any" value="20.9">
                    <p> De acordo com a parte do filme acima, escolha a alternativa correta:</p>
                    <ul class="payment-methods">
 <li class="payment-method2 paypal">
                    <input type="radio" name="msg" value="David seems to be happy."/><label for="paypal" style="font-size:18px;"> David seems to be happy. David parece estar feliz.<br /> </label>
                    </li>
                    <li class="payment-method2 paypal">
                    <input type="radio" name="msg" value="David seems to be crying."/> <label for="paypal" style="font-size:18px;">David seems to be crying. David parece estar chorando. <br /> </label>
                   </li>
                   <li class="payment-method paypal">
                    <input type="radio" name="msg" value="David seems to be worried."/><label for="paypal" style="font-size:18px;"> David seems to be worried. David parece estar preocupado.<br /></label>
</li>
</ul>
