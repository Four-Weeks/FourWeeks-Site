...
<html lang="pt-BR">
    ...
    <body>
        ...
        <div class="menu cor3">
            ...
            <ul class= "nav">
                <li><a href='lista_aulas.php' style="color:#002a80"><h4>Episodio 3 - Aula 12 - Lição 2 - Parte 2</h4></a></li>
                <li style="margin-left:400px;"><h4><a href="Filme_ep_3_aula12_lic2_part1.php"><img  src="img/back.png" style="width:20px;" border="0"></a>Lição 2 - Parte 2 <a href="Filme_ep_3_aula12_lic2_part3.php"> <img  src="img/next-1.png" style="width:20px;" border="0"></a> </h4></li>
...
Charlie: A conta.</p>
                        ...
                        <source src="https://videos.universidadedoingles.com.br/yesman/audios/mp3/Ag_Mp_E3_P2.mp3" type="audio/mpeg">
                         ...
                         <INPUT TYPE="hidden" NAME="b1" step="any" value="37.62">


                                                 <INPUT TYPE="hidden" NAME="msg" value="Parabéns por mais essa etapa (Aula 12 Lição 2 Parte 2)">
