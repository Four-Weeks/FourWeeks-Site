  ...
  width: 25px;
    ...
    <body>
        ...
        <div class="menu cor3">
            ...
            <ul class= "nav">
                <li><a href='lista_aulas.php' style="color:#002a80"><h4>Episodio 3 - Aula 11 - Lição 1 - Parte 2</h4></a></li>
                <li style="margin-left:400px;"><h4><a href="Filme_ep_3_aula11_lic1_part1.php"><img  src="img/back.png" style="width:20px;" border="0"></a>Lição 1 - Parte 2 <a href="Filme_ep_3_aula11_lic1_part3.php"> <img  src="img/next-1.png" style="width:20px;" border="0"></a> </h4></li>
...
<video id="video" src="https://videos.universidadedoingles.com.br/agentes/videos/Ag_E3_P2.mp4" ></video>
  </div>
</div>
<script>
...
<script>
    ...
    <form method="POST" action="mail.php">
                         <INPUT TYPE="hidden" NAME="b1" step="any" value="33">

                    <p> De acordo com a parte do filme acima, escolha a alternativa correta:</p>
                     <ul class="payment-methods">
 <li class="payment-method2 paypal">
                    <input type="radio" name="msg" value="David met Elise again because they are working together."/><label for="paypal" style="font-size:18px;"> David met Elise again because they are working together. David encontrou Elise porque eles estão trabalhando juntos.<br /> </label>
                    </li>
                    <li class="payment-method2 paypal">
                    <input type="radio" name="msg" value="Elise met David at the bank."/><label for="paypal" style="font-size:18px;"> Elise met David at the bank. Elise encontrou David no banco.<br /></label>
                   </li>
                   <li class="payment-method paypal">
                    <input type="radio" name="msg" value="David met Elise because he has been taking the same bus for three years."/><label for="paypal" style="font-size:18px;"> David met Elise because he has been taking the same bus for three years. David encontrou Elise porque ele pega o mesmo ônibus há três anos.<br /></label>
</li>
</ul>
