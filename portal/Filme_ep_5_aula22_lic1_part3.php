  ...
  width: 25px;
    ...
    <body>
        ...
        <div class="menu cor3">
            ...
            <ul class= "nav">
                <li><a href='lista_aulas.php' style="color:#002a80"><h4>Episodio 5 - Aula 22 - Lição 1 - Parte 3</h4></a></li>
                <li style="margin-left:400px;"><h4><a href="Filme_ep_5_aula22_lic1_part2.php"><img  src="img/back.png" style="width:20px;" border="0"></a>Lição 1 - Parte 3 <a href="Filme_ep_5_aula22_lic1_part4.php"> <img  src="img/next-1.png" style="width:20px;" border="0"></a> </h4></li>
...
<script>
    $(document).ready(function() {
                  ...
                  <form method="POST" action="mail.php">
                         <INPUT TYPE="hidden" NAME="b1" step="any" value="68.64">


                                      <p> De acordo com a parte do filme acima, escolha a alternativa correta:</p>
                    <ul class="payment-methods">
 <li class="payment-method2 paypal">
                    <input type="radio" name="msg" value="Harry says that David has no chance in the politics."/> <label for="paypal" style="font-size:18px;">Harry says that David has no chance in the politics. Harry diz que David não tem chances na política. <br /> </label>
                    </li>
                    <li class="payment-method2 paypal">
                    <input type="radio" name="msg" value="David says he is fine in the politics."/> <label for="paypal" style="font-size:18px;">David says he is fine in the politics. Davi diz que está bem na política. <br /></label>
                    </li>
                    <li class="payment-method paypal">
                    <input type="radio" name="msg" value="David says he isn't fine in the politics."/><label for="paypal" style="font-size:18px;">David says he isn't fine in the politics. Davi diz que não está bem na política.<br /></label>
                </li>
