...
<html lang="pt-BR">
    ...
    <body>
        ...
        <div class="menu cor3">
            ...
            <ul class= "nav">
                <li><a href='lista_aulas.php' style="color:#002a80"><h4>Episodio 6 - Aula 27 - Lição 4 - Parte 2</h4></a></li>
                <li style="margin-left:400px;"><h4><a href="Filme_ep_6_aula27_lic4_part1.php"><img  src="img/back.png" style="width:20px;" border="0"></a>Lição 4 - Parte 2 <a href="Filme_ep_6_aula27_lic5_part1.php"> <img  src="img/next-1.png" style="width:20px;" border="0"></a> </h4></li>
 ...
 $cS = ($_SG['caseSensitive']) ? 'BINARY' : '';
            ...
            <div class="span8">
                ...
                <div class="hero-unit">
                    <h3>Complementos Present Perfect</h3>
                    <div class="wrapper">
        ...
        <!-- SUBMIT -->
                    ...
                    <div class="content list" style="background:white;"> 
                                            ...
                                            <br>
                                             ...
                                             <p> Com a matéria "Complementos Present Perfect" explicada crie 5 frases usando as horas, como por exemplo:</p>
                                            <br>
                                            <p>We have studied english on this month.</p>
                                           
                                            <br>
                                            <div align='center'>
                                               
                                                         <form method="POST" action="mail.php">
                         <INPUT TYPE="hidden" NAME="b1" step="any" value="85.80">
