  ...
  width: 25px;
    ...
    <body>
        ...
        <div class="menu cor3">
            ...
            <ul class= "nav">
                <li><a href='lista_aulas.php' style="color:#002a80"><h4>Episodio 5 - Aula 21 - Lição 1 - Parte 2</h4></a></li>
                <li style="margin-left:400px;"><h4><a href="Filme_ep_5_aula21_lic1_part1.php"><img  src="img/back.png" style="width:20px;" border="0"></a>Lição 1 - Parte 2 <a href="Filme_ep_5_aula21_lic1_part3.php"> <img  src="img/next-1.png" style="width:20px;" border="0"></a> </h4></li>
...
<video id="video" src="https://videos.universidadedoingles.com.br/agentes/videos/Ag_E5_P2.mp4" ></video>
  </div>
</div>
<script>
...
<script>
    $(document).ready(function() {
                ...
                <form method="POST" action="mail.php">
                         <INPUT TYPE="hidden" NAME="b1" step="any" value="64.90">

                        <p> De acordo com a parte do filme acima, escolha a alternativa correta:</p>
                     <ul class="payment-methods">
 <li class="payment-method2 paypal">
                    <input type="radio" name="msg" value="David leaves Elise at the hospital because he received a phone call."/><label for="paypal" style="font-size:18px;">  David leaves Elise at the hospital because he received a phone call. David deixa Elise no hospital porque ele recebeu uma ligação telefônica. <br /> </label>
                    </li>
                    <li class="payment-method2 paypal">
                    <input type="radio" name="msg" value="Elise asks him to leave her."/><label for="paypal" style="font-size:18px;">Elise asks him to leave her. Elise pede a ele para deixá-la. <br /></label>
                   </li>
                   <li class="payment-method paypal">
                    <input type="radio" name="msg" value="David leaves Elise at the hospital bacause he's afraid to ruin her future."/><label for="paypal" style="font-size:18px;"> David leaves Elise at the hospital bacause he's afraid to ruin her future. David deixa Elise no hospital porque ele está com medo de arruinar o futuro dela. <br /></label>
</li>
</ul>
