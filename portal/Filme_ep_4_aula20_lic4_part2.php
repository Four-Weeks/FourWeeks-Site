...
<html lang="pt-BR">
    ...
    <body>
        ...
        <div class="menu cor3">
            ...
            <ul class= "nav">
                <li><a href='lista_aulas.php' style="color:#002a80"><h4>Episodio 4 - Aula 20 - Lição 4 - Parte 2</h4></a></li>
                <li style="margin-left:400px;"><h4><a href="Filme_ep_4_aula20_lic4_part1.php"><img  src="img/back.png" style="width:20px;" border="0"></a>Lição 4 - Parte 2 <a href="Filme_ep_5_aula21_lic1_part1.php"> <img  src="img/next-1.png" style="width:20px;" border="0"></a> </h4></li>
 ...
 $cS = ($_SG['caseSensitive']) ? 'BINARY' : '';
        ...
        <form method="POST" action="mail.php">
                         <INPUT TYPE="hidden" NAME="b1" step="any" value="64.46">    
