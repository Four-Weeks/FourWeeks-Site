...
<html lang="pt-BR">
    ...
    <body>
        ...
        <div class="menu cor3">
            ...
            <ul class= "nav">
                <li><a href='lista_aulas.php' style="color:#002a80"><h4>Episodio 4 - Aula 18 - Lição 4 - Parte 1</h4></a></li>
                <li style="margin-left:400px;"><h4><a href="Filme_ep_4_aula18_lic3_part4.php"><img  src="img/back.png" style="width:20px;" border="0"></a>Lição 4 - Parte 1 <a href="Filme_ep_4_aula18_lic4_part2.php"> <img  src="img/next-1.png" style="width:20px;" border="0"></a> </h4></li>
 ...
 $cS = ($_SG['caseSensitive']) ? 'BINARY' : '';
            ...
            <div class="span8">
                ...
                <div class="hero-unit">
                    <h3>Música - I believe I can fly</h3>
                    <div class="wrapper">
        ...
        <!-- SUBMIT -->
                    ...
                    <div class="content list" style="background:white;"> 
                     ...
                     <form method="POST" action="mail.php">
                         <INPUT TYPE="hidden" NAME="b1" step="any" value="58.74">
                        <INPUT TYPE="hidden" NAME="msg" value="Parabéns por mais essa etapa (Aula 18 Lição 4 Parte 1)">
