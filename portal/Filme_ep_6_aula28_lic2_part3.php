...
<html lang="pt-BR">
    ...
    <body>
        ...
        <div class="menu cor3">
            ...
            <ul class= "nav">
                <li><a href='lista_aulas.php' style="color:#002a80"><h4>Episodio 6 - Aula 28 - Lição 2 - Parte 3</h4></a></li>
                <li style="margin-left:400px;"><h4><a href="Filme_ep_6_aula28_lic2_part2.php"><img  src="img/back.png" style="width:20px;" border="0"></a>Lição 2 - Parte 3 <a href="Filme_ep_6_aula28_lic2_part4.php"> <img  src="img/next-1.png" style="width:20px;" border="0"></a> </h4></li>
...
<video id="video" src="https://videos.universidadedoingles.com.br/agentes/videos/Ag_Pt_E6_P3.mp4" ></video>
  </div>
</div>
<script>
...
<script>
    $(document).ready(function() {
                    ...
                    <form method="POST" action="mail.php">
                         <INPUT TYPE="hidden" NAME="b1" step="any" value="87.56">                   
                   <INPUT TYPE="hidden" NAME="msg" value="Parabéns por mais essa etapa (Aula 28 Lição 2 Parte 3)">
