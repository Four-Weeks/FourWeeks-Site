  ...
  width: 25px;
    ...
    <body>
        ...
        <div class="menu cor3">
            ...
            <ul class= "nav">
                <li><a href='lista_aulas.php' style="color:#002a80"><h4>Episodio 3 - Aula 12 - Lição 1 - Parte 4</h4></a></li>
                <li style="margin-left:400px;"><h4><a href="Filme_ep_3_aula12_lic1_part3.php"><img  src="img/back.png" style="width:20px;" border="0"></a>Lição 1 - Parte 4 <a href="Filme_ep_3_aula12_lic2_part1.php"> <img  src="img/next-1.png" style="width:20px;" border="0"></a> </h4></li>
...
<script>
    $(document).ready(function() {
      ...
      <form method="POST" action="mail.php">
                         <INPUT TYPE="hidden" NAME="b1" step="any" value="37.18">
 ...
 <li class="payment-method2 paypal">
                    <input type="radio" name="msg" value="David and the agents talk about politics."/><label for="paypal" style="font-size:18px;"> David and the agents talk about politics. David e os agentes estão falando sobre política. <br /> </label>
                    </li>
                    <li class="payment-method paypal">
                    <input type="radio" name="msg" value="David and the agents talk about the plan."/> <label for="paypal" style="font-size:18px;"> David and the agents talk about the plan. David e os agentes estão falando sobre o plano. <br /> </label>
                   </li>
                   <li class="payment-method2 paypal">
                    <input type="radio" name="msg" value="David and the agents are talking about sports."/><label for="paypal" style="font-size:18px;">David and the agents are talking about sports. David e os agentes estão falando sobre esportes. <br /></label>
</li>
</ul>
