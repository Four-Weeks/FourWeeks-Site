...
<html lang="pt-BR">
    ...
    <body>
        ...
        <div class="menu cor3">
            ...
            <ul class= "nav">
                <li><a href='lista_aulas.php' style="color:#002a80"><h4>Episodio 1 - Aula 2 - Lição 4 - Parte 2</h4></a></li>
                <li style="margin-left:400px;"><h4><a href="Filme_ep_1_aula2_lic4_part1.php"><img  src="img/back.png" style="width:20px;" border="0"></a>Lição 4 - Parte 2 <a href="Filme_ep_1_aula2_lic4_part3.php"> <img  src="img/next-1.png" style="width:20px;" border="0"></a> </h4></li>
 ...
 $cS = ($_SG['caseSensitive']) ? 'BINARY' : '';
    ...
    <div class="audio">
      <audio id="player_instrucao">
        <source src="audios/Video-aula2.m4a" type="audio/mpeg">
...
<script type="text/javascript">
  ...
  function addZero(number){if(number < 10){return "0"+number;}else{return number;}}
        ...
        <!-- SUBMIT -->
                    ...
                    <br>
                   <!-- <iframe width="780" height="415" src="https://www.youtube.com/embed/G2IG1uSxKoc" frameborder="0" allowfullscreen></iframe>
                    --><div class="content list" style="background:white;"> 
                        ...
                        <div class="title">
                                            ...
                                            <p>9:03 - It's nine oh three/It's nine and three -São nove e três.</p>
                                            <p>9:05 – It´s five past nine / It´s nine oh five. São cinco passada das nove /São cinco e cinco</p>
                                            <p>9:15 – It´s a quarter past nine / It´s nine fifteen. São um quarto passada das nove/ São nove e quinze.</p> 
                                            <p>9:30 – It´s half past nine / It´s nine thirty. São metade passada das nove/ São nove e meia.</p>
                                            <p>9:45 – It´s a quarter to ten / It´s nine forty five.São um quarto para as dez./São nove e quarenta e cinco.</p>
                                            <p>9:50 – It´s ten to ten / It´s nine fifty. São dez para as dez./São nove e cinquenta</p> 
                                            <p>9:55 – It´s five to ten / It´s nine fifty-five. São cinco para as dez/ São nove e cinquenta e cinco</p>
                    ...
                    <form method="POST" action="mail.php">
                                    ...
                                    <INPUT TYPE="hidden" NAME="b1" step="any" value="6.7">

                        <INPUT TYPE="hidden" NAME="msg" value="Parabéns por mais essa etapa (Aula 2 Lição 4 Parte 2)">
