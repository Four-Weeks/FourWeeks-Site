  ...
  width: 25px;
    ...
    <body>
        ...
        <div class="menu cor3">
            ...
            <ul class= "nav">
                <li><a href='lista_aulas.php' style="color:#002a80"><h4>Episodio 6 - Aula 27 - Lição 1 - Parte 4</h4></a></li>
                <li style="margin-left:400px;"><h4><a href="Filme_ep_6_aula27_lic1_part3.php"><img  src="img/back.png" style="width:20px;" border="0"></a>Lição 1 - Parte 4 <a href="Filme_ep_6_aula27_lic2_part1.php"> <img  src="img/next-1.png" style="width:20px;" border="0"></a> </h4></li>
...
<video id="video" src="https://videos.universidadedoingles.com.br/agentes/videos/Ag_E6_P4.mp4" ></video>
  </div>
</div>
<script>
...
<script>
    ...
    <form method="POST" action="mail.php">
                         <INPUT TYPE="hidden" NAME="b1" step="any" value="83.60">


                                             <p> De acordo com a parte do filme acima, escolha a alternativa correta:</p>
                    <ul class="payment-methods">
 <li class="payment-method2 paypal">
                    <input type="radio" name="msg" value="The agents disappeared when David and Elise talked to them. "/> <label for="paypal" style="font-size:18px;">The agents disappeared when David and Elise talked to them. <br /></label>
                    </li>
                    <li class="payment-method2 paypal">
                    <input type="radio" name="msg" value="The agents disappeared when David and Elise said they were wrong. "/> <label for="paypal" style="font-size:18px;"> The agents disappeared when David and Elise said they were wrong. <br /></label>
                    </li>
                    <li class="payment-method paypal">
                    <input type="radio" name="msg" value="The agents disappeared when David and Elise kissed each other."/> <label for="paypal" style="font-size:18px;"> The agents disappeared when David and Elise kissed each other. <br/> </label>
                     </li>
                 </ul>
