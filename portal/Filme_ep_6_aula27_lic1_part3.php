  ...
  width: 25px;
    ...
    <body>
        ...
        <div class="menu cor3">
            ...
            <ul class= "nav">
                <li><a href='lista_aulas.php' style="color:#002a80"><h4>Episodio 6 - Aula 27 - Lição 1 - Parte 3</h4></a></li>
                <li style="margin-left:400px;"><h4><a href="Filme_ep_6_aula27_lic1_part2.php"><img  src="img/back.png" style="width:20px;" border="0"></a>Lição 1 - Parte 3 <a href="Filme_ep_6_aula27_lic1_part4.php"> <img  src="img/next-1.png" style="width:20px;" border="0"></a> </h4></li>
...
<video id="video" src="https://videos.universidadedoingles.com.br/agentes/videos/Ag_E6_P3.mp4" ></video>
  </div>
</div>
<script>
...
<script>
    $(document).ready(function() {
                  ...
                  <form method="POST" action="mail.php">
                         <INPUT TYPE="hidden" NAME="b1" step="any" value="83.38">


                                      <p> De acordo com a parte do filme acima, escolha a alternativa correta:</p>
                    <ul class="payment-methods">
 <li class="payment-method paypal">
                    <input type="radio" name="msg" value="David gives Elise two options : go with him or stay and never see him again"/> <label for="paypal" style="font-size:18px;">David gives Elise two options : go with him or stay and never see him again<br /> </label>
                    </li>
                    <li class="payment-method2 paypal">
                    <input type="radio" name="msg" value="David asks Elise to stay and doesn't follow him through the door."/> <label for="paypal" style="font-size:18px;">David asks Elise to stay and doesn't follow him through the door. <br /></label>
                    </li>
                    <li class="payment-method2 paypal">
                    <input type="radio" name="msg" value="David says to Elise that he doesn't want to be close to her."/><label for="paypal" style="font-size:18px;">David says to Elise that he doesn't want to be close to her.<br /></label>
                </li>
