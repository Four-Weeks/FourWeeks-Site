...
<html lang="pt-BR">
    ...
    <body>
        ...
        <div class="menu cor3">
            ...
            <ul class= "nav">
                <li><a href='lista_aulas.php' style="color:#002a80"><h4>Episodio 5 - Aula 22 - Lição 4 - Parte 3</h4></a></li>
                <li style="margin-left:400px;"><h4><a href="Filme_ep_5_aula22_lic4_part2.php"><img  src="img/back.png" style="width:20px;" border="0"></a>Lição 4 - Parte 3 <a href="Filme_ep_5_aula22_lic5_part1.php"> <img  src="img/next-1.png" style="width:20px;" border="0"></a> </h4></li>
        ...
        <!-- SUBMIT -->
                    ...
                    <div class="content list" style="background:white;"> 
                                            ...
                                            <br>
                                             ...
                                             <p> Com a matéria "There was/were" explicada crie 5 frases usando as horas, como por exemplo:</p>
                                            <br>
                                            <p>There was a friend in my house yesterday.</p>
                                           
                                            <br>
                                            <div align='center'>
                                               
                                                         <form method="POST" action="mail.php">
                         <INPUT TYPE="hidden" NAME="b1" step="any" value="71.28">
