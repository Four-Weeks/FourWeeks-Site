  ...
  width: 25px;
    ...
    <body>
        ...
        <div class="menu cor3">
            ...
            <ul class= "nav">
                <li><a href='lista_aulas.php' style="color:#002a80"><h4>Episodio 4 - Aula 16 - Lição 1 - Parte 2</h4></a></li>
                <li style="margin-left:400px;"><h4><a href="Filme_ep_4_aula16_lic1_part1.php"><img  src="img/back.png" style="width:20px;" border="0"></a>Lição 1 - Parte 2 <a href="Filme_ep_4_aula16_lic1_part3.php"> <img  src="img/next-1.png" style="width:20px;" border="0"></a> </h4></li>
...
<video id="video" src="https://videos.universidadedoingles.com.br/agentes/videos/Ag_E4_P2.mp4" ></video>
  </div>
</div>
<script>
...
<script>
    $(document).ready(function() {
                ...
                <form method="POST" action="mail.php">
                         <INPUT TYPE="hidden" NAME="b1" step="any" value="49.07">

                        <p> De acordo com a parte do filme acima, escolha a alternativa correta:</p>
                     <ul class="payment-methods">
 <li class="payment-method2 paypal">
                    <input type="radio" name="msg" value="David met Elise again because they are working together."/><label for="paypal" style="font-size:18px;"> Elise convinces David to fight with a big man. Elise convence David a lutar com um homem grande. <br /> </label>
                    </li>
                    <li class="payment-method paypal">
                    <input type="radio" name="msg" value="Elise met David at the bank."/><label for="paypal" style="font-size:18px;">Elise talks to David about dancing. Elise conversa com David sobre dançar. <br /></label>
                   </li>
                   <li class="payment-method2 paypal">
                    <input type="radio" name="msg" value="David met Elise because he has been taking the same bus for three years."/><label for="paypal" style="font-size:18px;"> Elise doesn't like to dance. Elise não gosta de dançar.<br /></label>
</li>
</ul>
