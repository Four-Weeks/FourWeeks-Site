  ...
  width: 25px;
    ...
    <body>
        ...
        <div class="menu cor3">
            ...
            <ul class= "nav">
                <li><a href='lista_aulas.php' style="color:#002a80"><h4>Episodio 2 - Aula 6 - Lição 1 - Parte 3</h4></a></li>
                <li style="margin-left:400px;"><h4><a href="Filme_ep_2_aula6_part2.php"><img  src="img/back.png" style="width:20px;" border="0"></a>Lição 1 - Parte 3 <a href="Filme_ep_2_aula6_lic1_part4.php"> <img  src="img/next-1.png" style="width:20px;" border="0"></a> </h4></li>
...
<script>
    $(document).ready(function() {
         ...
         <form method="POST" action="mail.php">
                         <INPUT TYPE="hidden" NAME="b1" step="any" value="16.73">
                    <p> De acordo com a parte do filme acima, escolha a alternativa correta:</p>
                    <ul class="payment-methods">
 <li class="payment-method paypal">
                    <input type="radio" name="msg" value="The agents catch David."/> <label for="paypal" style="font-size:18px;">The agents catch David. Os agentes pegam David.<br /> </label>
                    </li>
                    <li class="payment-method2 paypal">
                    <input type="radio" name="msg" value="David wants to be with the agents."/> <label for="paypal" style="font-size:18px;">David wants to be with the agents. David quer ficar com os agentes.<br /></label>
                    </li>
                    <li class="payment-method2 paypal">
                    <input type="radio" name="msg" value="All David´s coworkers see what happened with him."/><label for="paypal" style="font-size:18px;">All David´s coworkers see what happened with him. Todos os colegas de trabalho de David viram o que aconteceu com ele.<br /></label>
                </li>
