...
<html lang="pt-BR">
    ...
    <body>
        ...
        <div class="menu cor3">
            ...
            <ul class= "nav">
                <li><a href='lista_aulas.php' style="color:#002a80"><h4>Episodio 3 - Aula 12 - Lição 4 - Parte 4</h4></a></li>
                <li style="margin-left:400px;"><h4><a href="Filme_ep_3_aula12_lic4_part3.php"><img  src="img/back.png" style="width:20px;" border="0"></a>Lição 4 - Parte 4 <a href="Filme_ep_3_aula12_lic5_part1.php"> <img  src="img/next-1.png" style="width:20px;" border="0"></a> </h4></li>
        ...
        <!-- SUBMIT -->
                    ...
                    <div class="content list" style="background:white;"> 
                       ...
                       <div class="title"><div align="center" style="color:red">Diálogo 12 - Indo ao banco</div> 
                                            ...
                                            <p> Crie o seu Diálogo 12 com base no tema apresentado com os conhecimentos adquiridos até aqui.
                                            Lembre-se de definir personagens com as letras A, B ou demais. </p>
                                            <p>Por exemplo:</p>
                                            <p>A: Would you like to go to the bank for me?</p>
                                            <p>B: Of course!</p>
                         ...
                         <INPUT TYPE="hidden" NAME="b1" step="any" value="39.82">
