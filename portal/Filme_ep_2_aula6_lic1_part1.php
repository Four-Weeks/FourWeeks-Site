  ...
  width: 25px;
    ...
    <body>
        ...
        <div class="menu cor3">
            ...
            <ul class= "nav">
                <li><a href='lista_aulas.php' style="color:#002a80"><h4>Episodio 2 - Aula 6 - Lição 1 - Parte 1</h4></a></li>
                <li style="margin-left:400px;"><h4>Lição 1 - Parte 1 <a href="Filme_ep_2_aula6_lic1_part2.php"> <img  src="img/next-1.png" style="width:20px;" border="0"></a> </h4></li>
...
<video id="video" src="https://videos.universidadedoingles.com.br/agentes/videos/Ag_E2_P1.mp4" ></video>
  </div>
</div>
<script>
...
<script>
    $(document).ready(function() {
         ...
         <form method="POST" action="mail.php">
                         <INPUT TYPE="hidden" NAME="b1" step="any" value="16.5">
                    <p> De acordo com a parte do filme acima, escolha a alternativa correta:</p>
                    <ul class="payment-methods">
 <li class="payment-method2 paypal">
                    <input type="radio" name="msg" id="msg" value="The man wearing the hat is working out"/><label for="paypal" style="font-size:18px;"> The man wearing the hat is working out. O homem usando o chapéu está fazendo exercícios.<br /></label>
                   </li>
                   <li class="payment-method paypal"> 
                    <input type="radio"   name="msg" id="msg" value="The man wearing the hat was hit by a car."/><label for="paypal" style="font-size:18px;"> The man wearing the hat was hit by a car. O homem usado o chapéu foi atropelado.<br /></label>
                    </li>
                    <li class="payment-method2 paypal">
                    <input type="radio"   name="msg" id="msg" value="The man wearing the hat took the bus."/><label for="paypal" style="font-size:18px;"> The man wearing the hat took the bus. O homem usando o chapéu pegou o onibus. <br /></label>
                </li>
