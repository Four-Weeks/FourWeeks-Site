  ...
  width: 25px;
    ...
    <body>
        ...
        <div class="menu cor3">
            ...
            <ul class= "nav">
                <li><a href='lista_aulas.php' style="color:#002a80"><h4>Episodio 3 - Aula 12 - Lição 1 - Parte 1</h4></a></li>
                <li style="margin-left:400px;"><h4>Lição 1 - Parte 1 <a href="Filme_ep_3_aula12_lic1_part2.php"> <img  src="img/next-1.png" style="width:20px;" border="0"></a> </h4></li>
...
<script>
    $(document).ready(function() {
                   ...
                   <form method="POST" action="mail.php">
                         <INPUT TYPE="hidden" NAME="b1" step="any" value="36.31">
...
<ul class="payment-methods">
 <li class="payment-method2 paypal">
                    <input type="radio" name="msg" id="msg" value="Elise is happy because she met David again."/> <label for="paypal" style="font-size:18px;">Elise is happy because she met David again. Elise está feliz porque ela encontrou David.<br /></label>
                    </li>
                     <li class="payment-method2 paypal">
                    <input type="radio"   name="msg" id="msg" value="Elise doesn´t remember who David is"/> <label for="paypal" style="font-size:18px;">Elise doesn´t remember who David is. Elise não se lembra quem é David.<br/> </label>
                    </li>
                     <li class="payment-method paypal">
                    <input type="radio"   name="msg" id="msg" value="Elise is mad because David didn´t call her in three years."/> <label for="paypal" style="font-size:18px;"> Elise is mad because David didn´t call her in three years. Eise está brava porque o David não ligou para ela em 3 anos.  <br/> </label>
                </li>
            </ul>
