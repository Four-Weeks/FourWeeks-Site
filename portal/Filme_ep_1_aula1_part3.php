  ...
  width: 25px;
    ...
    <body>
        ...
        <div class="menu cor3">
            ...
            <ul class= "nav">
                <li><a href='lista_aulas.php' style="color:#002a80"><h4>Episodio 1 - Aula 1 - Lição 1 - Parte 3</h4></a></li>
                <li style="margin-left:400px;"><h4><a href="Filme_ep_1_aula1_part2.php"><img  src="img/back.png" style="width:20px;" border="0"></a>Lição 1 - Parte 3 <a href="Filme_ep_1_aula1_part4.php"> <img  src="img/next-1.png" style="width:20px;" border="0"></a> </h4></li>
...
<script>
    $(document).ready(function() {
                  ...
                  <form method="POST" action="mail.php">
                    <INPUT TYPE="hidden" NAME="b1" step="any" value="0.66">
                    <p> De acordo com a parte do filme acima, escolha a alternativa correta:</p>

                    <ul class="payment-methods">
 <li class="payment-method2 paypal">
                    <input type="radio" name="msg" value="He fights a beautiful woman."/> <label for="paypal" style="font-size:18px;">He fights a beautiful woman. Ele briga com uma mulher bonita.<br /></label>
                   
</li>

 <li class="payment-method2 paypal">
                    <input type="radio" name="msg" value="He falls at the restroom."/> <label for="paypal" style="font-size:18px;"> He falls at the restroom. Ele cai no banheiro.<br /></label>
                    </li>
 <li class="payment-method paypal">

                    <input type="radio" name="msg" value="He kisses a woman at the restroom. "/> <label for="paypal" style="font-size:18px;"> He kisses a woman at the restroom. Ele beija uma mulher no banheiro.<br /></label>
