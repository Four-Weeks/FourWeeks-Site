  ...
  width: 25px;
    ...
    <body>
        ...
        <div class="menu cor3">
            ...
            <ul class= "nav">
                <li><a href='lista_aulas.php' style="color:#002a80"><h4>Episodio 1 - Aula 2 - Lição 1 - Parte 4</h4></a></li>
                <li style="margin-left:400px;"><h4><a href="Filme_ep_1_aula2_lic1_part3.php"><img  src="img/back.png" style="width:20px;" border="0"></a>Lição 1 - Parte 4 <a href="Filme_ep_1_aula2_lic2_part1.php"> <img  src="img/next-1.png" style="width:20px;" border="0"></a> </h4></li>
...
<video id="video" src="https://videos.universidadedoingles.com.br/agentes/videos/Ag_E1_P4.mp4" ></video>
  </div>
</div>
<script>
...
<script>
    ...
    <form method="POST" action="mail.php">
        ...
        <INPUT TYPE="hidden" NAME="b1" step="any" value="4.62">
                    <p> De acordo com a parte do filme acima, escolha a alternativa correta:</p>
                    <ul class="payment-methods">
                <li class="payment-method2 paypal">
                    <input type="radio" name="msg" value="The campaign group seems happy during his speech."/> <label for="paypal" style="font-size:18px;"> The campaign group seems happy during his speech. O grupo da campanha parece feliz durante o discurso dele.<br /> </label>
                    </li>

                <li class="payment-method2 paypal">
                    <input type="radio" name="msg" value="David is not doing a speech."/> <label for="paypal" style="font-size:18px;">David is not doing a speech. David não está fazendo um discurso. <br /> </label>
                    </li>
                    <li class="payment-method paypal">
                
                    <input type="radio" name="msg" value="The campaign group seems worried during his speech."/>  <label for="paypal" style="font-size:18px;"> The campaign group seems worried during his speech. O grupo da campanha parece preocupado durante o discurso dele.<br /></label>
                </li>
