...
<html lang="pt-BR">
    ...
    <body>
        ...
        <div class="menu cor3">
            ...
            <ul class= "nav">
                <li><a href='lista_aulas.php' style="color:#002a80"><h4>Episodio 1 - Aula 2 - Lição 2 - Parte 1</h4></a></li>
                <li style="margin-left:400px;"><h4><a href="Filme_ep_1_aula2_lic1_part4.php"><img  src="img/back.png" style="width:20px;" border="0"></a>Lição 2 - Parte 1 <a href="Filme_ep_1_aula2_lic2_part2.php"> <img  src="img/next-1.png" style="width:20px;" border="0"></a> </h4></li>
...
<script type="text/javascript">
  ...
  function addZero(number){if(number < 10){return "0"+number;}else{return number;}}
        ...
        <!-- SUBMIT -->
                    ...
                    <INPUT TYPE="hidden" NAME="b1" step="any" value="4.84">
                        Digite 30 palavras que estão no texto com sua tradução:
                            <textarea rows="3" style="width:400px;" cols="50" name="msg" id="msg">
