  ...
  width: 25px;
    ...
    <body>
        ...
        <div class="menu cor3">
            ...
            <ul class= "nav">
                <li><a href='lista_aulas.php' style="color:#002a80"><h4>Episodio 5 - Aula 22 - Lição 1 - Parte 1</h4></a></li>
                <li style="margin-left:400px;"><h4>Lição 1 - Parte 1 <a href="Filme_ep_5_aula22_lic1_part2.php"> <img  src="img/next-1.png" style="width:20px;" border="0"></a> </h4></li>
...
<script>
    $(document).ready(function() {
                ...
                <form method="POST" action="mail.php">
                         <INPUT TYPE="hidden" NAME="b1" step="any" value="68.20">
                    <p> De acordo com a parte do filme acima, escolha a alternativa correta:</p>
                    <ul class="payment-methods">
 <li class="payment-method2 paypal">
                    <input type="radio" name="msg" id="msg" value="David doesn't go to Elise's presentation."/><label for="paypal" style="font-size:18px;">David doesn't go to Elise's presentation. David não vai a apresentação de Elise.<br /></label>
                   </li>
                   <li class="payment-method2 paypal"> 
                    <input type="radio"   name="msg" id="msg" value="David doesn't hit Thompson's face at the hospital."/><label for="paypal" style="font-size:18px;"> David doesn't hit Thompson's face at the hospital. David não acerta o rosto de Thompson no hospital.<br /></label>
                    </li>
                    <li class="payment-method paypal">
                    <input type="radio"   name="msg" id="msg" value="Thompson says that David is impulsive."/><label for="paypal" style="font-size:18px;"> Thompson says that David is impulsive. Thompson diz que que David é impulsivo. <br /></label>
                </li>
