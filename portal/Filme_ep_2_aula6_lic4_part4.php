...
<html lang="pt-BR">
    ...
    <body>
        ...
        <div class="menu cor3">
            ...
            <ul class= "nav">
                <li><a href='lista_aulas.php' style="color:#002a80"><h4>Episodio 2 - Aula 6 - Lição 4 - Parte 4</h4></a></li>
                <li style="margin-left:400px;"><h4><a href="Filme_ep_2_aula6_lic4_part3.php"><img  src="img/back.png" style="width:20px;" border="0"></a>Lição 4 - Parte 4 <a href="Filme_ep_2_aula6_lic5_part1.php"> <img  src="img/next-1.png" style="width:20px;" border="0"></a> </h4></li>
  ...
  function addZero(number){if(number < 10){return "0"+number;}else{return number;}}
        ...
        <!-- SUBMIT -->
                    ...
                    <div class="content list" style="background:white;"> 
                       ...
                       <div class="title"><div align="center" style="color:red">Diálogo 6 - Restaurante</div> 
                                                </div>
                                            ...
                                            <p>Por exemplo:</p>
                                            <p>A: Good afternoon, My name is Cléber and I did a reservation on this restaurant.</p>
                                            <p>B: Just a moment sir!</p>
                                            <br>
         ...
         <form method="POST" action="mail.php">
                         <INPUT TYPE="hidden" NAME="b1" step="any" value="19.59">
