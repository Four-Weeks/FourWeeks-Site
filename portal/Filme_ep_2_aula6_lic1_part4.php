  ...
  width: 25px;
    ...
    <body>
        ...
        <div class="menu cor3">
            ...
            <ul class= "nav">
                <li><a href='lista_aulas.php' style="color:#002a80"><h4>Episodio 2 - Aula 6 - Lição 1 - Parte 4</h4></a></li>
                <li style="margin-left:400px;"><h4><a href="Filme_ep_2_aula6_lic1_part3.php"><img  src="img/back.png" style="width:20px;" border="0"></a>Lição 1 - Parte 4 <a href="Filme_ep_2_aula6_lic2_part1.php"> <img  src="img/next-1.png" style="width:20px;" border="0"></a> </h4></li>
...
<video id="video" src="https://videos.universidadedoingles.com.br/agentes/videos/Ag_E2_P4.mp4" ></video>
  </div>
</div>
<script>
...
<script>
    $(document).ready(function() {
         ...
         <form method="POST" action="mail.php">
                         <INPUT TYPE="hidden" NAME="b1" step="any" value="17.16">
                    <p> De acordo com a parte do filme acima, escolha a alternativa correta:</p>
                    <ul class="payment-methods">
 <li class="payment-method2 paypal">
                    <input type="radio" name="msg" value="David meets Harry at a supermarket."/> <label for="paypal" style="font-size:18px;">David meets Harry at a supermarket. David encontra Harry no supermercado.<br /></label>
                    </li>
                    <li class="payment-method2 paypal">
                    <input type="radio" name="msg" value=" David meets Harry at a drugstore."/> <label for="paypal" style="font-size:18px;"> David meets Harry at a drugstore. David encontra Harry na farmácia. <br /></label>
                    </li>
                    <li class="payment-method paypal">
                    <input type="radio" name="msg" value="David meets Harry at a bar."/> <label for="paypal" style="font-size:18px;"> David meets Harry at a bar. David encontra Harry no bar. <br /> </label>
                     </li>
                 </ul>
