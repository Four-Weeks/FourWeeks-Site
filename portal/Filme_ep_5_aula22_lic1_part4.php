  ...
  width: 25px;
    ...
    <body>
        ...
        <div class="menu cor3">
            ...
            <ul class= "nav">
                <li><a href='lista_aulas.php' style="color:#002a80"><h4>Episodio 5 - Aula 22 - Lição 1 - Parte 4</h4></a></li>
                <li style="margin-left:400px;"><h4><a href="Filme_ep_5_aula22_lic1_part3.php"><img  src="img/back.png" style="width:20px;" border="0"></a>Lição 1 - Parte 4 <a href="Filme_ep_5_aula22_lic2_part1.php"> <img  src="img/next-1.png" style="width:20px;" border="0"></a> </h4></li>
...
<video id="video" src="https://videos.universidadedoingles.com.br/agentes/videos/Ag_E5_P4.mp4" ></video>
  </div>
</div>
<script>
...
<script>
    ...
    <form method="POST" action="mail.php">
                         <INPUT TYPE="hidden" NAME="b1" step="any" value="68.86">


                                             <p> De acordo com a parte do filme acima, escolha a alternativa correta:</p>
                    <ul class="payment-methods">
 <li class="payment-method2 paypal">
                    <input type="radio" name="msg" value="David is talking about the next election."/> <label for="paypal" style="font-size:18px;">David is talking about the next election. David está falando sobre a próxima eleição.<br /></label>
                    </li>
                    <li class="payment-method paypal">
                    <input type="radio" name="msg" value="David talks with Harry about the agent's emotions."/> <label for="paypal" style="font-size:18px;"> David talks with Harry about the agent's emotions. David fala com Harry sobre as emoções dos agentes.<br /></label>
                    </li>
                    <li class="payment-method2 paypal">
                    <input type="radio" name="msg" value="Davis is talking about Elise's next presentation."/> <label for="paypal" style="font-size:18px;"> Davis is talking about Elise's next presentation. Davis está falando sobre a próxima apresentação de Elise <br/> </label>
                     </li>
                 </ul>
