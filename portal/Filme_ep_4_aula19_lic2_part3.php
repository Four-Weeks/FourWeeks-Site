...
<html lang="pt-BR">
    ...
    <body>
        ...
        <div class="menu cor3">
            ...
            <ul class= "nav">
                <li><a href='lista_aulas.php' style="color:#002a80"><h4>Episodio 4 - Aula 19 - Lição 2 - Parte 3</h4></a></li>
                <li style="margin-left:400px;"><h4><a href="Filme_ep_4_aula19_lic2_part2.php"><img  src="img/back.png" style="width:20px;" border="0"></a>Lição 2 - Parte 3 <a href="Filme_ep_4_aula19_lic3_part1.php"> <img  src="img/next-1.png" style="width:20px;" border="0"></a> </h4></li>
  ...
  function addZero(number){if(number < 10){return "0"+number;}else{return number;}}
        ...
        <!-- SUBMIT -->
                    ...
                    <div class="content list" style="background:white;"> 
                                            ...
                                            <p> Com a matéria "ANY/SOME/NO" explicada crie suas próprias frases, como por exemplo:</p>
                                            <br>
                         ...
                         <INPUT TYPE="hidden" NAME="b1" step="any" value="61.16">
