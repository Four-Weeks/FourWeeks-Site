  ...
  width: 25px;
    ...
    <body>
        ...
        <div class="menu cor3">
            ...
            <ul class= "nav">
                <li><a href='lista_aulas.php' style="color:#002a80"><h4>Episodio 5 - Aula 21 - Lição 1 - Parte 1</h4></a></li>
                <li style="margin-left:400px;"><h4>Lição 1 - Parte 1 <a href="Filme_ep_5_aula21_lic1_part2.php"> <img  src="img/next-1.png" style="width:20px;" border="0"></a> </h4></li>
...
<video id="video" src="https://videos.universidadedoingles.com.br/agentes/videos/Ag_E5_P1.mp4" ></video>
  </div>
</div>
<script>
...
<script>
    $(document).ready(function() {
                   ...
                   <form method="POST" action="mail.php">
                         <INPUT TYPE="hidden" NAME="b1" step="any" value="64.68">


                                             <p> De acordo com a parte do filme acima, escolha a alternativa correta:</p>
                    <ul class="payment-methods">
 <li class="payment-method2 paypal">
                    <input type="radio" name="msg" id="msg" value="Thompson is trying to convince David to be with Elise."/><label for="paypal" style="font-size:18px;">Thompson is trying to convince David to be with Elise. Thompson está tentando convencer David a ficar com Elise<br /></label>
                   </li>
                   <li class="payment-method paypal"> 
                    <input type="radio"   name="msg" id="msg" value="Thompson talks with David about the consequences of his acts in the future."/><label for="paypal" style="font-size:18px;">Thompson talks with David about the consequences of his acts in the future. Thompson fala com David sobre as consequências de seus atos no futuro. <br /></label>
                    </li>
                    <li class="payment-method2 paypal">
                    <input type="radio"   name="msg" id="msg" value="David takes Elise to the presentation."/><label for="paypal" style="font-size:18px;"> David takes Elise to the presentation. David leva Elise a apresentação. <br /></label>
                </li>
