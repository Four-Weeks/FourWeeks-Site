...
<html lang="pt-BR">
    ...
    <body>
        ...
        <div class="menu cor3">
            ...
            <ul class= "nav">
                <li><a href='lista_aulas.php' style="color:#002a80"><h4>Episodio 3 - Aula 13 - Lição 1 - Parte 1</h4></a></li>
                <li style="margin-left:400px;"><h4>Lição 1 - Parte 1 <a href="Filme_ep_3_aula13_lic1_part2.php"> <img  src="img/next-1.png" style="width:20px;" border="0"></a> </h4></li>
...
<script>
    $(document).ready(function() {
                      ...
                      <form method="POST" action="mail.php">
                         <INPUT TYPE="hidden" NAME="b1" step="any" value="40.05">
                   
                   <INPUT TYPE="hidden" NAME="msg" value="Parabéns por mais essa etapa (Aula 13 Lição 1 Parte 1)">
