  ...
  width: 25px;
    ...
    <body>
        ...
        <div class="menu cor3">
            ...
            <ul class= "nav">
                <li><a href='lista_aulas.php' style="color:#002a80"><h4>Episodio 4 - Aula 17 - Lição 1 - Parte 1</h4></a></li>
                <li style="margin-left:400px;"><h4>Lição 1 - Parte 1 <a href="Filme_ep_4_aula17_lic1_part2.php"> <img  src="img/next-1.png" style="width:20px;" border="0"></a> </h4></li>
...
<video id="video" src="https://videos.universidadedoingles.com.br/agentes/videos/Ag_E4_P1.mp4" ></video>
  </div>
</div>
<script>
...
<script>
    $(document).ready(function() {
                ...
                <form method="POST" action="mail.php">
                         <INPUT TYPE="hidden" NAME="b1" step="any" value="52.58">
                    <p> De acordo com a parte do filme acima, escolha a alternativa correta:</p>
                    <ul class="payment-methods">
 <li class="payment-method2 paypal">
                    <input type="radio" name="msg" id="msg" value="The agents are talking about the Senators."/><label for="paypal" style="font-size:18px;">The agents are talking about the Senators. Os Agentes estão falando sobre os Senadores.<br /></label>
                   </li>
                   <li class="payment-method2 paypal"> 
                    <input type="radio"   name="msg" id="msg" value="The agents are talking about David's speeches."/><label for="paypal" style="font-size:18px;"> The agents are talking about David's speeches. Os Agentes estão falando sobre os discursos de David.<br /></label>
                    </li>
                    <li class="payment-method paypal">
                    <input type="radio"   name="msg" id="msg" value="The agents are talking about David and Elise."/><label for="paypal" style="font-size:18px;"> The agents are talking about David and Elise. Os agentes estão falando sobre David e Elise. <br /></label>
                </li>
