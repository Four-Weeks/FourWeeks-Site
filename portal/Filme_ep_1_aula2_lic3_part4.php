 ...
 ul { list-style: none; }
    ...
    <body>
        ...
        <div class="menu cor3">
            ...
            <ul class= "nav">
                <li><a href='lista_aulas.php' style="color:#002a80"><h4>Episodio 1 - Aula 2 - Lição 3 - Parte 4</h4></a></li>
                <li style="margin-left:400px;"><h4><a href="Filme_ep_1_aula2_lic3_part3.php"><img  src="img/back.png" style="width:20px;" border="0"></a>Lição 3 - Parte 4 <a href="Filme_ep_1_aula2_lic4_part1.php"> <img  src="img/next-1.png" style="width:20px;" border="0"></a> </h4></li>
...
{document.getElementById('divTeste').innerHTML = 'Parado...';}
  ...
  <pre id="log" style="visibility:hidden;"></pre>
                    ...
                    <form method="POST" action="mail.php">
                                    ...
                                    <INPUT TYPE="hidden" NAME="b1" step="any" value="6.38">
