...
<html>
 ...
 $cS = ($_SG['caseSensitive']) ? 'BINARY' : '';
            ...
            <div class="span8">
                ...
                <div class="hero-unit">
                    <div align="center" style="overflow: auto;"> <h3>Vídeo de Instrução</h3></div>
                      <div> <button class=" bt_menu btn btn-primary"  onclick="window.location.href = 'menu.php';">Voltar</button></div>
                    
                    <br><br>
                   <iframe allowfullscreen width='800' height='459' scrolling='no' frameborder='0' style='border: none;' src='https://www.wevideo.com/embed/#896370414' allowfullscreen></iframe>
