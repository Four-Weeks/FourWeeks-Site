...
<div class="container">
<form action="../API/db_emails_inscritos_novo_massa.php?inicio=0"  method="post" align="center">
...
<option value="NUNCA">Enviar apenas para quem nunca recebeu e-mails</option>
<option value="JA_RECEBEU" selected>Enviar para quem ja recebeu 1 ou mais e-mails</option>
...
<br>
<center><span>Ei, você pode chamar as seguintes chaves no e-mail (ID) e (EMAIL)</span></center>
