    ...
    <body>
        ...
        <div class="row-fluid">
            ...
            <div class="span8">
                ...
                <div class="hero-unit">
                    <div align="center" style="overflow: auto;"> <h3>Filmes/Séries</h3></div>
                    <div align="center">   <p><a style="color:#f89406; font-size:15px;" href='assinantes.php'>(Assinantes Premium)</a></p></div>
                    <div> <button class=" bt_menu btn btn-primary"  onclick="window.location.href='menu.php';">Voltar</button></div>
                    
                    <div align="center"> 
                        <p>Converse e debata com seu professor sobre a Série estudada!</p>
                        <a  href="skype:" style="color:#04c"><h4>Converse com seu professor</h4></a>
                    </div>
            </div>
            </div> </div>
