<html>
    <head>
        ...
        <!-- Facebook Conversion Code for Leads - Cleber da Hora 1 -->
...
<style>
  ...
  ga('create', 'UA-61850308-1', 'auto');
  ga('send', 'pageview');

</script>
  </head>
    <body>
        <div class="menu cor1 left">
        ...
        <div  class="container" align="center"><h2>Seja Blimeyco!</h2></div>
        <br>
        <div class="container" align="center"> <iframe src="https://www.youtube.com/embed/JsxlIYY7op4?controls=0&autoplay=1&rel=0&showinfo=0" width="700" height="481" frameborder="0"></iframe></div>
        <br>
        

        <br><br>
 <div style="background:#149bdf" class="left">
            <div class="container">
        ...
        <div class="container masthead">
            <div align="center"><p style="font-size:18px;"><b>Compre em até 10x com um dos botões abaixo:</b></p></div>
            <br>
            <div class="row">
                <div class="span6" align="right">  
                    ...
                    <form action="https://pagseguro.uol.com.br/checkout/v2/cart.html?action=add" method="post">
                        ...
                        <input type="hidden" name="itemCode" value="00E0ABC7EDED28DFF45A7F814E3F5AA0">
                ...
                <div class="span6">
                    <form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
                        ...
                        <input type="hidden" name="hosted_button_id" value="LE822RR93HSCQ">
        ...
        <div style="background:#1DB0B0">
            <div class="container">
                <h3 style="color:#fff">Newsletter</h3>
                <div class="row">
                    <div class="span6">

                        <p class="lead" style="color:#fff">Receba dicas de como falar inglês gratuitamente!</p>


                        <form action="adicionaContato.php" method="POST">
                            <input class="span4" style="padding: 12px 4px; " type="text" name="nome" placeholder="Nome"/><br/>
                            <input class="span4" style="padding: 12px 4px; " type="text" name="email" placeholder="E-mail"/><br/>
                            <input class="span4" style="padding: 12px 4px; " type="text" name="profissao" placeholder="Profissão"/><br/>
