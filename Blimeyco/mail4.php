...
<?php
$emailUsuario = "suporte@fourweeks.esy.es";
$nome = $_SESSION['usuarioNome'];
$email = 'suporte@fourweeks.esy.es';
$assunto= 'PAI(Planilha de Acompanhamento Individual)';
$mensagem = $_POST['msg'];
$form= $_POST['b1'];


$email_remetente = $_SESSION['usuarioEmail'];
...
?>
                        <div align="center">  <form  action='lista_aulas.php'>
                            <p>Sua barra de progresso será atualizada na próxima sessão</p>
