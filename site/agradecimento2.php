    ...
    <body style="background:white;">
        ...
        <div class="menu" style="background:white;">
            <div align="center">
                ...
                <br>
                        <h3>Parabéns, você acaba de se inscrever no maior evento de educação de idiomas!</h3>
...
<h3>
       <?php
$emailUsuario = "attendance@fourweeks.com.br";
$email = 'attendance@fourweeks.com.br';
$assunto= 'Você Vai Ficar Milionário';
$mensagem = "Qual seu nome?\n ".$_POST['nomeCliente']." \n\n  
Qual a sua idade? \n ".$_POST['idadeCliente']." \n\n 
Qual seu melhor e-mail? \n ".$_POST['emailCliente']." \n\n 
Qual a importância do idioma Inglês em sua vida? \n ".$_POST['msg']." \n\n 
Porque você precisa falar inglês? \n ".$_POST['pqCliente']." \n\n 
Qual sua profissão atual? \n ".$_POST['profissaoCliente']." \n \n
Você deseja usar o idioma em qual ambiente?(Pessoal ou Profissional)? \n ".$_POST['idiomaCliente']." \n\n 
Já cursou algum idioma?Qual? \n ".$_POST['linguaCliente']." \n\n 
Há quanto tempo atrás? \n ".$_POST['tempoCliente']." \n\n 
Quanto tempo do seu tempo diário pode dedicar ao estudo do idioma? \n ".$_POST['tempo2Cliente']." \n\n 
Qual seu telefone? \n ".$_POST['phoneCliente']." \n\n 
...
$email_remetente = $_POST['emailCliente'];
