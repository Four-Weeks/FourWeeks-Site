        ...
        <div class="row-fluid">
            ...
            <div class="span8">
                ...
                <div class="hero-unit">
                    ...
                    <div align="center">
                   <button class="btn btn-primary"  onclick="window.location.href = 'crie1.php';">Crie suas Frases 1</button>
                   <button class="btn btn-primary"  onclick="window.location.href = 'crie2.php';">Crie suas Frases 2</button>
                   <button class="btn btn-primary"  onclick="window.location.href = 'crie3.php';">Crie suas Frases 3</button>
                   </div>
                    </div>
            </div>
        </div>
