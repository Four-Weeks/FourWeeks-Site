    ...
    <body>
         <div class="menu cor1">
            ...
            <ul class= "nav">
                ...
                <li><a href='conversacao.php'> Conversação</a>
                </li>
            </ul>
...
// O nome original do arquivo no computador do usuário
        ...
        if ($arqError == 0) {
            ...
            if (array_search($arqType, $tiposPermitidos) === false) {
                ...
                $arquivo = '/home/u489056370/public_html/fotos/' . $_SESSION['usuarioFoto'] . '';
                if($arquivo == '/home/u489056370/public_html/fotos/usuario.jpg')
                {
                  //  !unlink(arquivo);
                ...
                $pasta = '/home/u489056370/public_html/fotos/';
...
// O nome original do arquivo no computador do usuário
        ...
        if ($arqError == 0) {
            ...
            if (array_search($arqType, $tiposPermitidos) === false) {
                ...
                $arquivo = 'http:/blimeyco.com/fotos/' . $_SESSION['usuarioFoto'] . '';
                if($arquivo == 'http:/blimeyco.com/fotos/usuario.jpg')
                {
                  //  !unlink(arquivo);
