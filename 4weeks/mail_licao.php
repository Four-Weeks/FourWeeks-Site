...
function AvancaProgresso(){
    ...
    $licao =$_SESSION['usuarioLicao'];
    $sessaoID2 = $_SESSION['usuarioID'];
    $progresso = $_SESSION['usuarioProgresso'];
    $form = $_POST['b1'];
...
?>
                        <div align="center">  <form  action='remover.php'>
                            <p>Agora é o momento de respirar e descansar a mente, clique no botão deslogar e logue em sua conta novamente 
                                para atualizar sua barra de progresso.</p>
                        <button type="submit" class ="btn btn-primary" onclick="window.location.href='remover.php';">Deslogar</button>
                        </form>
                            </div>
                    </div>
