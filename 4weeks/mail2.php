...
line-height: 1.25;
    ...
    <body>
        ...
        <ul class= "nav">
          ...
          <!--  <li><a href='index.php'>Sobre Nós</a></li>
            <li><a href='index.php'>Contatos</a>
   ...
   <div class="row">
       <div class="span6">
           <br><br> <div class="hero-unit" style="background: #fff">
               <div align="center">   
...
$nome = $_POST['nome'];
$email = 'suporte@blimeyco.com';
$assunto=  utf8_decode($_POST['assunto']);
$mensagem =$_POST['msg'];
$mensagem.= "<br> $emailUsuario";
...
$envio = @mail("$email", "$assunto", "$mensagem", $headers, "-f$email_remetente");
...
if($envio){
    ...
    echo 'Problemas ao enviar dúvidas, tente mais tarde!';
}
...
<!-- FINAL FORMULARIO BOTAO PAGSEGURO -->
          ...
          <div class="span6" align="center">
           <img src="img/icon-tira-duvidas.png">
       </div>  
     </div>  
