            ...
            <div class="span8">
                ...
                <div class="hero-unit">
                    ...
                    <div class="row-fluid" align="center">
                        <form class="navbar-form " action="alteraTeste.php"  enctype="multipart/form-data" method="POST">
                        
                            <div class="input-prepend">

                                <span class="add-on "><i class="icon-font"></i></span><input class="span9" type="text" name="nome" placeholder="Alterar Nome">

                            </div>
                            <button type="submit" name="alteraNome" value="altera o nome " class ="btn btn-primary">Alterar Nome</button>
                        
                        <br>
                        <br>
                            <div class="input-prepend">
                                <span class="add-on"><i class="icon-cog"></i></span><input class="span9" type="text" name="senha" placeholder="Alterar Senha">
                            </div>
                        <button type="submit" name="alteraSenha"  value="altera a senha" class ="btn btn-primary">Alterar Senha</button>
                       
                        <br>
                        <br>
                           <div class="input-prepend">
                                <span class="add-on"><i class="icon-lock"></i></span><input class="span9" type="text" name="profissao" placeholder="alterar profissão">
                            </div>
                            <button type="submit" name="alteraProfissao" value=" altera a profissao" class ="btn btn-primary"> Alterar Profissão </button>  
                        
                        <br>
                        <br>
                            <div class="input-prepend">
                                <span class="add-on"><i class="icon-user"></i></span><input style="left:40px;" class="span9" type="file" name="foto" id="foto">

                            </div>
                            <p style="font-size:12px;">obs: Apenas fotos: pjpeg, jpeg, png, gif. extensão máxima(1024x1024)</p>
                            <button type="submit" name="altera" value="Alterar Imagem" class ="btn btn-primary">Alterar Foto</button>

                        
                        <br>
                        <br>
                        <div align="left"> <button  type ="submit" name="alteraTudo" value="altera todas as informações" class ="btn btn-primary">Alterar Tudo</button>
                        </div>
                        </form>
                    </div>
